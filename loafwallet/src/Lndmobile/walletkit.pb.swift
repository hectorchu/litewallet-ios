...
struct Walletrpc_Account {
	...
	var extendedPublicKey: String = .init()
	...
	/// are imported into.
	var derivationPath: String = .init()
...
struct Walletrpc_ImportAccountResponse {
	...
	fileprivate var _account: Walletrpc_Account?
}
...
struct Walletrpc_ListSweepsResponse {
	...
	var sweeps: Walletrpc_ListSweepsResponse.OneOf_Sweeps?

	var transactionDetails: Lnrpc_TransactionDetails {
		get {
			if case let .transactionDetails(v)? = sweeps { return v }
	...
	var transactionIds: Walletrpc_ListSweepsResponse.TransactionIDs {
		get {
			if case let .transactionIds(v)? = sweeps { return v }
		...
		case transactionIds(Walletrpc_ListSweepsResponse.TransactionIDs)
			...
			static func == (lhs: Walletrpc_ListSweepsResponse.OneOf_Sweeps, rhs: Walletrpc_ListSweepsResponse.OneOf_Sweeps) -> Bool {
				...
				case (.transactionDetails, .transactionDetails): return {
						guard case let .transactionDetails(l) = lhs, case let .transactionDetails(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.transactionIds, .transactionIds): return {
						guard case let .transactionIds(l) = lhs, case let .transactionIds(r) = rhs else { preconditionFailure() }
						return l == r
					}()
...
struct Walletrpc_FundPsbtRequest {
	...
	var template: Walletrpc_FundPsbtRequest.OneOf_Template?
	...
	var psbt: Data {
		get {
			if case let .psbt(v)? = template { return v }
			return Data()
		}
	...
	var raw: Walletrpc_TxTemplate {
		get {
			if case let .raw(v)? = template { return v }
			return Walletrpc_TxTemplate()
		}
		set { template = .raw(newValue) }
	}

	var fees: Walletrpc_FundPsbtRequest.OneOf_Fees?

	///
	/// The target number of blocks that the transaction should be confirmed in.
	var targetConf: UInt32 {
		get {
			if case let .targetConf(v)? = fees { return v }
			return 0
		}
	...
	var satPerVbyte: UInt64 {
		get {
			if case let .satPerVbyte(v)? = fees { return v }
			return 0
		}
		...
		case raw(Walletrpc_TxTemplate)
			...
			static func == (lhs: Walletrpc_FundPsbtRequest.OneOf_Template, rhs: Walletrpc_FundPsbtRequest.OneOf_Template) -> Bool {
				...
				case (.psbt, .psbt): return {
						guard case let .psbt(l) = lhs, case let .psbt(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.raw, .raw): return {
						guard case let .raw(l) = lhs, case let .raw(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
		...
		case satPerVbyte(UInt64)
			...
			static func == (lhs: Walletrpc_FundPsbtRequest.OneOf_Fees, rhs: Walletrpc_FundPsbtRequest.OneOf_Fees) -> Bool {
				...
				case (.targetConf, .targetConf): return {
						guard case let .targetConf(l) = lhs, case let .targetConf(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.satPerVbyte, .satPerVbyte): return {
						guard case let .satPerVbyte(l) = lhs, case let .satPerVbyte(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
private let _protobuf_package = "walletrpc"
...
extension Walletrpc_LeaseOutputRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularMessageField(value: &_outpoint)
			case 3: try decoder.decodeSingularUInt64Field(value: &expirationSeconds)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if expirationSeconds != 0 {
			try visitor.visitSingularUInt64Field(value: expirationSeconds, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_LeaseOutputResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &expiration)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if expiration != 0 {
			try visitor.visitSingularUInt64Field(value: expiration, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_KeyReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt32Field(value: &keyFingerPrint)
			case 2: try decoder.decodeSingularInt32Field(value: &keyFamily)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if keyFingerPrint != 0 {
			try visitor.visitSingularInt32Field(value: keyFingerPrint, fieldNumber: 1)
		}
		if keyFamily != 0 {
			try visitor.visitSingularInt32Field(value: keyFamily, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_AddrRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &account)
			case 2: try decoder.decodeSingularEnumField(value: &type)
			case 3: try decoder.decodeSingularBoolField(value: &change)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !account.isEmpty {
			try visitor.visitSingularStringField(value: account, fieldNumber: 1)
		}
		if type != .unknown {
			try visitor.visitSingularEnumField(value: type, fieldNumber: 2)
		}
		if change != false {
			try visitor.visitSingularBoolField(value: change, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_Account: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularEnumField(value: &addressType)
			case 3: try decoder.decodeSingularStringField(value: &extendedPublicKey)
			case 4: try decoder.decodeSingularBytesField(value: &masterKeyFingerprint)
			case 5: try decoder.decodeSingularStringField(value: &derivationPath)
			case 6: try decoder.decodeSingularUInt32Field(value: &externalKeyCount)
			case 7: try decoder.decodeSingularUInt32Field(value: &internalKeyCount)
			case 8: try decoder.decodeSingularBoolField(value: &watchOnly)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if addressType != .unknown {
			try visitor.visitSingularEnumField(value: addressType, fieldNumber: 2)
		}
		if !extendedPublicKey.isEmpty {
			try visitor.visitSingularStringField(value: extendedPublicKey, fieldNumber: 3)
		}
		if !masterKeyFingerprint.isEmpty {
			try visitor.visitSingularBytesField(value: masterKeyFingerprint, fieldNumber: 4)
		}
		if !derivationPath.isEmpty {
			try visitor.visitSingularStringField(value: derivationPath, fieldNumber: 5)
		}
		if externalKeyCount != 0 {
			try visitor.visitSingularUInt32Field(value: externalKeyCount, fieldNumber: 6)
		}
		if internalKeyCount != 0 {
			try visitor.visitSingularUInt32Field(value: internalKeyCount, fieldNumber: 7)
		}
		if watchOnly != false {
			try visitor.visitSingularBoolField(value: watchOnly, fieldNumber: 8)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_ImportAccountRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &name)
			case 2: try decoder.decodeSingularStringField(value: &extendedPublicKey)
			case 3: try decoder.decodeSingularBytesField(value: &masterKeyFingerprint)
			case 4: try decoder.decodeSingularEnumField(value: &addressType)
			case 5: try decoder.decodeSingularBoolField(value: &dryRun)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !extendedPublicKey.isEmpty {
			try visitor.visitSingularStringField(value: extendedPublicKey, fieldNumber: 2)
		}
		if !masterKeyFingerprint.isEmpty {
			try visitor.visitSingularBytesField(value: masterKeyFingerprint, fieldNumber: 3)
		}
		if addressType != .unknown {
			try visitor.visitSingularEnumField(value: addressType, fieldNumber: 4)
		}
		if dryRun != false {
			try visitor.visitSingularBoolField(value: dryRun, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_ImportAccountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeRepeatedStringField(value: &dryRunExternalAddrs)
			case 3: try decoder.decodeRepeatedStringField(value: &dryRunInternalAddrs)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !dryRunExternalAddrs.isEmpty {
			try visitor.visitRepeatedStringField(value: dryRunExternalAddrs, fieldNumber: 2)
		}
		if !dryRunInternalAddrs.isEmpty {
			try visitor.visitRepeatedStringField(value: dryRunInternalAddrs, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &txHex)
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !txHex.isEmpty {
			try visitor.visitSingularBytesField(value: txHex, fieldNumber: 1)
		}
		if !label.isEmpty {
...
extension Walletrpc_PublishResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &publishError)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !publishError.isEmpty {
			try visitor.visitSingularStringField(value: publishError, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_SendOutputsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &satPerKw)
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if satPerKw != 0 {
			try visitor.visitSingularInt64Field(value: satPerKw, fieldNumber: 1)
		}
		if !outputs.isEmpty {
...
extension Walletrpc_EstimateFeeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt32Field(value: &confTarget)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if confTarget != 0 {
			try visitor.visitSingularInt32Field(value: confTarget, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_PendingSweep: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularEnumField(value: &witnessType)
			case 3: try decoder.decodeSingularUInt32Field(value: &amountSat)
			case 4: try decoder.decodeSingularUInt32Field(value: &satPerByte)
			case 5: try decoder.decodeSingularUInt32Field(value: &broadcastAttempts)
			case 6: try decoder.decodeSingularUInt32Field(value: &nextBroadcastHeight)
			case 7: try decoder.decodeSingularBoolField(value: &force)
			case 8: try decoder.decodeSingularUInt32Field(value: &requestedConfTarget)
			case 9: try decoder.decodeSingularUInt32Field(value: &requestedSatPerByte)
			case 10: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			case 11: try decoder.decodeSingularUInt64Field(value: &requestedSatPerVbyte)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if witnessType != .unknownWitness {
			try visitor.visitSingularEnumField(value: witnessType, fieldNumber: 2)
		}
		if amountSat != 0 {
			try visitor.visitSingularUInt32Field(value: amountSat, fieldNumber: 3)
		}
		if satPerByte != 0 {
			try visitor.visitSingularUInt32Field(value: satPerByte, fieldNumber: 4)
		}
		if broadcastAttempts != 0 {
			try visitor.visitSingularUInt32Field(value: broadcastAttempts, fieldNumber: 5)
		}
		if nextBroadcastHeight != 0 {
			try visitor.visitSingularUInt32Field(value: nextBroadcastHeight, fieldNumber: 6)
		}
		if force != false {
			try visitor.visitSingularBoolField(value: force, fieldNumber: 7)
		}
		if requestedConfTarget != 0 {
			try visitor.visitSingularUInt32Field(value: requestedConfTarget, fieldNumber: 8)
		}
		if requestedSatPerByte != 0 {
			try visitor.visitSingularUInt32Field(value: requestedSatPerByte, fieldNumber: 9)
		}
		if satPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: satPerVbyte, fieldNumber: 10)
		}
		if requestedSatPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: requestedSatPerVbyte, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_PendingSweepsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &pendingSweeps)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !pendingSweeps.isEmpty {
			try visitor.visitRepeatedMessageField(value: pendingSweeps, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_BumpFeeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_outpoint)
			case 2: try decoder.decodeSingularUInt32Field(value: &targetConf)
			case 3: try decoder.decodeSingularUInt32Field(value: &satPerByte)
			case 4: try decoder.decodeSingularBoolField(value: &force)
			case 5: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if targetConf != 0 {
			try visitor.visitSingularUInt32Field(value: targetConf, fieldNumber: 2)
		}
		if satPerByte != 0 {
			try visitor.visitSingularUInt32Field(value: satPerByte, fieldNumber: 3)
		}
		if force != false {
			try visitor.visitSingularBoolField(value: force, fieldNumber: 4)
		}
		if satPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: satPerVbyte, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_ListSweepsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &verbose)
			default: break
			}
		}
	}
...
extension Walletrpc_ListSweepsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.sweeps {
						hadOneofValue = true
						if case let .transactionDetails(m) = current { v = m }
					}
			...
			case 2: try {
					...
					if let current = self.sweeps {
						hadOneofValue = true
						if case let .transactionIds(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .transactionDetails?: try {
				guard case let .transactionDetails(v)? = self.sweeps else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .transactionIds?: try {
				guard case let .transactionIds(v)? = self.sweeps else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case nil: break
		}
...
extension Walletrpc_ListSweepsResponse.TransactionIDs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedStringField(value: &transactionIds)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !transactionIds.isEmpty {
			try visitor.visitRepeatedStringField(value: transactionIds, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_LabelTransactionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &label)
			case 3: try decoder.decodeSingularBoolField(value: &overwrite)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if overwrite != false {
			try visitor.visitSingularBoolField(value: overwrite, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_FundPsbtRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 5: try decoder.decodeSingularStringField(value: &account)
			case 6: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 7: try decoder.decodeSingularBoolField(value: &spendUnconfirmed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		switch template {
		case .psbt?: try {
				guard case let .psbt(v)? = self.template else { preconditionFailure() }
				try visitor.visitSingularBytesField(value: v, fieldNumber: 1)
			}()
		case .raw?: try {
				guard case let .raw(v)? = self.template else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case nil: break
		}
		switch fees {
		case .targetConf?: try {
				guard case let .targetConf(v)? = self.fees else { preconditionFailure() }
				try visitor.visitSingularUInt32Field(value: v, fieldNumber: 3)
			}()
		case .satPerVbyte?: try {
				guard case let .satPerVbyte(v)? = self.fees else { preconditionFailure() }
				try visitor.visitSingularUInt64Field(value: v, fieldNumber: 4)
			}()
		case nil: break
		}
		if !account.isEmpty {
			try visitor.visitSingularStringField(value: account, fieldNumber: 5)
		}
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 6)
		}
		if spendUnconfirmed != false {
			try visitor.visitSingularBoolField(value: spendUnconfirmed, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_FundPsbtResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularInt32Field(value: &changeOutputIndex)
			case 3: try decoder.decodeRepeatedMessageField(value: &lockedUtxos)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if changeOutputIndex != 0 {
			try visitor.visitSingularInt32Field(value: changeOutputIndex, fieldNumber: 2)
		}
		if !lockedUtxos.isEmpty {
			try visitor.visitRepeatedMessageField(value: lockedUtxos, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_TxTemplate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufUInt64>.self, value: &outputs)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !outputs.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufUInt64>.self, value: outputs, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_UtxoLease: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try decoder.decodeSingularBytesField(value: &id)
			case 2: try decoder.decodeSingularMessageField(value: &_outpoint)
			case 3: try decoder.decodeSingularUInt64Field(value: &expiration)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if expiration != 0 {
			try visitor.visitSingularUInt64Field(value: expiration, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_FinalizePsbtResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &signedPsbt)
			case 2: try decoder.decodeSingularBytesField(value: &rawFinalTx)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !rawFinalTx.isEmpty {
			try visitor.visitSingularBytesField(value: rawFinalTx, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Walletrpc_ListLeasesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &lockedUtxos)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !lockedUtxos.isEmpty {
			try visitor.visitRepeatedMessageField(value: lockedUtxos, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}

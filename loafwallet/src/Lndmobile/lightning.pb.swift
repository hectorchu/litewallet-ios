...
struct Lnrpc_Utxo {
	...
	fileprivate var _outpoint: Lnrpc_OutPoint?
}
...
struct Lnrpc_FeeLimit {
	...
	var fixed: Int64 {
		get {
			if case let .fixed(v)? = limit { return v }
			return 0
		}
	...
	var fixedMsat: Int64 {
		get {
			if case let .fixedMsat(v)? = limit { return v }
			return 0
		}
	...
	var percent: Int64 {
		get {
			if case let .percent(v)? = limit { return v }
			return 0
		}
		...
		case percent(Int64)
			...
			static func == (lhs: Lnrpc_FeeLimit.OneOf_Limit, rhs: Lnrpc_FeeLimit.OneOf_Limit) -> Bool {
				...
				case (.fixed, .fixed): return {
						guard case let .fixed(l) = lhs, case let .fixed(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.fixedMsat, .fixedMsat): return {
						guard case let .fixedMsat(l) = lhs, case let .fixedMsat(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.percent, .percent): return {
						guard case let .percent(l) = lhs, case let .percent(r) = rhs else { preconditionFailure() }
						return l == r
					}()
...
struct Lnrpc_SendRequest {
	...
	/// must be encoded as base64.
	var paymentHash: Data = .init()

	///
	/// The hex-encoded hash to use within the payment's HTLC. Deprecated now
	/// that the REST gateway supports base64 encoding of bytes fields.
	var paymentHashString: String = .init()

	///
	/// A bare-bones invoice for a payment within the Lightning Network. With the
	/// details of the invoice, the sender has all the data necessary to send a
	/// payment to the recipient.
	var paymentRequest: String = .init()
	...
	mutating func clearFeeLimit() { _feeLimit = nil }
	...
	/// must be encoded as base64.
	var destCustomRecords: [UInt64: Data] = [:]
	...
	var paymentAddr: Data = .init()

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _feeLimit: Lnrpc_FeeLimit?
}
...
struct Lnrpc_SendResponse {
	...
	var paymentError: String = .init()

	var paymentPreimage: Data = .init()
	...
	mutating func clearPaymentRoute() { _paymentRoute = nil }
	...
	fileprivate var _paymentRoute: Lnrpc_Route?
}
...
struct Lnrpc_SendToRouteRequest {
	...
	mutating func clearRoute() { _route = nil }

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _route: Lnrpc_Route?
}
...
struct Lnrpc_ChannelAcceptRequest {
	...
	var nodePubkey: Data = .init()

	/// The hash of the genesis block that the proposed channel resides in.
	var chainHash: Data = .init()

	/// The pending channel id.
	var pendingChanID: Data = .init()
...
struct Lnrpc_ChannelAcceptResponse {
	...
	var upfrontShutdown: String = .init()
...
struct Lnrpc_ChannelPoint {
	...
	var fundingTxidBytes: Data {
		get {
			if case let .fundingTxidBytes(v)? = fundingTxid { return v }
			return Data()
		}
	...
	var fundingTxidStr: String {
		get {
			if case let .fundingTxidStr(v)? = fundingTxid { return v }
			return String()
		}
		...
		case fundingTxidStr(String)
			...
			static func == (lhs: Lnrpc_ChannelPoint.OneOf_FundingTxid, rhs: Lnrpc_ChannelPoint.OneOf_FundingTxid) -> Bool {
				...
				case (.fundingTxidBytes, .fundingTxidBytes): return {
						guard case let .fundingTxidBytes(l) = lhs, case let .fundingTxidBytes(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.fundingTxidStr, .fundingTxidStr): return {
						guard case let .fundingTxidStr(l) = lhs, case let .fundingTxidStr(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_OutPoint {
	...
	var txidBytes: Data = .init()

	/// Reversed, hex-encoded string representing the transaction id.
	var txidStr: String = .init()
...
struct Lnrpc_ConnectPeerRequest {
	...
	mutating func clearAddr() { _addr = nil }
	...
	fileprivate var _addr: Lnrpc_LightningAddress?
}
...
struct Lnrpc_ChannelCloseSummary {
	...
	var channelPoint: String = .init()

	///  The unique channel ID for the channel.
	var chanID: UInt64 = 0

	/// The hash of the genesis block that this channel resides within.
	var chainHash: String = .init()

	/// The txid of the transaction which ultimately closed this channel.
	var closingTxHash: String = .init()

	/// Public key of the remote peer that we formerly had a channel with.
	var remotePubkey: String = .init()
...
struct Lnrpc_Peer {
	...
	var features: [UInt32: Lnrpc_Feature] = [:]
...
struct Lnrpc_ChannelOpenUpdate {
	...
	mutating func clearChannelPoint() { _channelPoint = nil }

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _channelPoint: Lnrpc_ChannelPoint?
}
...
struct Lnrpc_CloseChannelRequest {
	...
	var deliveryAddress: String = .init()
...
struct Lnrpc_CloseStatusUpdate {
	...
	var update: Lnrpc_CloseStatusUpdate.OneOf_Update?

	var closePending: Lnrpc_PendingUpdate {
		get {
			if case let .closePending(v)? = update { return v }
	...
	var chanClose: Lnrpc_ChannelCloseUpdate {
		get {
			if case let .chanClose(v)? = update { return v }
		...
		case chanClose(Lnrpc_ChannelCloseUpdate)
			...
			static func == (lhs: Lnrpc_CloseStatusUpdate.OneOf_Update, rhs: Lnrpc_CloseStatusUpdate.OneOf_Update) -> Bool {
				...
				case (.closePending, .closePending): return {
						guard case let .closePending(l) = lhs, case let .closePending(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.chanClose, .chanClose): return {
						guard case let .chanClose(l) = lhs, case let .chanClose(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_ReadyForPsbtFunding {
	...
	var fundingAddress: String = .init()
...
struct Lnrpc_OpenStatusUpdate {
	...
	var update: Lnrpc_OpenStatusUpdate.OneOf_Update?
	...
	var chanPending: Lnrpc_PendingUpdate {
		get {
			if case let .chanPending(v)? = update { return v }
			return Lnrpc_PendingUpdate()
		}
	...
	var chanOpen: Lnrpc_ChannelOpenUpdate {
		get {
			if case let .chanOpen(v)? = update { return v }
	...
	var psbtFund: Lnrpc_ReadyForPsbtFunding {
		get {
			if case let .psbtFund(v)? = update { return v }
		...
		case psbtFund(Lnrpc_ReadyForPsbtFunding)
			...
			static func == (lhs: Lnrpc_OpenStatusUpdate.OneOf_Update, rhs: Lnrpc_OpenStatusUpdate.OneOf_Update) -> Bool {
				...
				case (.chanPending, .chanPending): return {
						guard case let .chanPending(l) = lhs, case let .chanPending(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.chanOpen, .chanOpen): return {
						guard case let .chanOpen(l) = lhs, case let .chanOpen(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.psbtFund, .psbtFund): return {
						guard case let .psbtFund(l) = lhs, case let .psbtFund(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_KeyDescriptor {
	...
	fileprivate var _keyLoc: Lnrpc_KeyLocator?
}
...
struct Lnrpc_ChanPointShim {
	...
	mutating func clearChanPoint() { _chanPoint = nil }
	...
	mutating func clearLocalKey() { _localKey = nil }

	/// The key of the remote party to use when creating the multi-sig output.
	var remoteKey: Data = .init()
	...
	fileprivate var _chanPoint: Lnrpc_ChannelPoint?
	fileprivate var _localKey: Lnrpc_KeyDescriptor?
}
...
struct Lnrpc_FundingShim {
	...
	var shim: Lnrpc_FundingShim.OneOf_Shim?
	...
	var chanPointShim: Lnrpc_ChanPointShim {
		get {
			if case let .chanPointShim(v)? = shim { return v }
	...
	var psbtShim: Lnrpc_PsbtShim {
		get {
			if case let .psbtShim(v)? = shim { return v }
		...
		case psbtShim(Lnrpc_PsbtShim)
			...
			static func == (lhs: Lnrpc_FundingShim.OneOf_Shim, rhs: Lnrpc_FundingShim.OneOf_Shim) -> Bool {
				...
				case (.chanPointShim, .chanPointShim): return {
						guard case let .chanPointShim(l) = lhs, case let .chanPointShim(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.psbtShim, .psbtShim): return {
						guard case let .psbtShim(l) = lhs, case let .psbtShim(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_FundingTransitionMsg {
	...
	var trigger: Lnrpc_FundingTransitionMsg.OneOf_Trigger?
	...
	var shimRegister: Lnrpc_FundingShim {
		get {
			if case let .shimRegister(v)? = trigger { return v }
	...
	var shimCancel: Lnrpc_FundingShimCancel {
		get {
			if case let .shimCancel(v)? = trigger { return v }
	...
	var psbtVerify: Lnrpc_FundingPsbtVerify {
		get {
			if case let .psbtVerify(v)? = trigger { return v }
	...
	var psbtFinalize: Lnrpc_FundingPsbtFinalize {
		get {
			if case let .psbtFinalize(v)? = trigger { return v }
		...
		case psbtFinalize(Lnrpc_FundingPsbtFinalize)
			...
			static func == (lhs: Lnrpc_FundingTransitionMsg.OneOf_Trigger, rhs: Lnrpc_FundingTransitionMsg.OneOf_Trigger) -> Bool {
				...
				case (.shimRegister, .shimRegister): return {
						guard case let .shimRegister(l) = lhs, case let .shimRegister(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.shimCancel, .shimCancel): return {
						guard case let .shimCancel(l) = lhs, case let .shimCancel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.psbtVerify, .psbtVerify): return {
						guard case let .psbtVerify(l) = lhs, case let .psbtVerify(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.psbtFinalize, .psbtFinalize): return {
						guard case let .psbtFinalize(l) = lhs, case let .psbtFinalize(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_PendingChannelsResponse {
	...
	struct PendingChannel {
		...
		/// A set of flags showing the current state of the channel.
		var chanStatusFlags: String = .init()
	...
	struct PendingOpenChannel {
		...
		mutating func clearChannel() { _channel = nil }
		...
		fileprivate var _channel: Lnrpc_PendingChannelsResponse.PendingChannel?
	}
	...
	struct Commitments {
		...
		var localTxid: String = .init()

		/// Hash of the remote version of the commitment tx.
		var remoteTxid: String = .init()

		/// Hash of the remote pending version of the commitment tx.
		var remotePendingTxid: String = .init()
...
struct Lnrpc_ChannelEventUpdate {
	...
	var channel: Lnrpc_ChannelEventUpdate.OneOf_Channel?

	var openChannel: Lnrpc_Channel {
		get {
			if case let .openChannel(v)? = channel { return v }
	...
	var closedChannel: Lnrpc_ChannelCloseSummary {
		get {
			if case let .closedChannel(v)? = channel { return v }
	...
	var activeChannel: Lnrpc_ChannelPoint {
		get {
			if case let .activeChannel(v)? = channel { return v }
	...
	var inactiveChannel: Lnrpc_ChannelPoint {
		get {
			if case let .inactiveChannel(v)? = channel { return v }
			return Lnrpc_ChannelPoint()
		}
	...
	var pendingOpenChannel: Lnrpc_PendingUpdate {
		get {
			if case let .pendingOpenChannel(v)? = channel { return v }
			return Lnrpc_PendingUpdate()
		}
	...
	var fullyResolvedChannel: Lnrpc_ChannelPoint {
		get {
			if case let .fullyResolvedChannel(v)? = channel { return v }
			return Lnrpc_ChannelPoint()
		}
		...
		case fullyResolvedChannel(Lnrpc_ChannelPoint)
			...
			static func == (lhs: Lnrpc_ChannelEventUpdate.OneOf_Channel, rhs: Lnrpc_ChannelEventUpdate.OneOf_Channel) -> Bool {
				...
				case (.openChannel, .openChannel): return {
						guard case let .openChannel(l) = lhs, case let .openChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.closedChannel, .closedChannel): return {
						guard case let .closedChannel(l) = lhs, case let .closedChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.activeChannel, .activeChannel): return {
						guard case let .activeChannel(l) = lhs, case let .activeChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.inactiveChannel, .inactiveChannel): return {
						guard case let .inactiveChannel(l) = lhs, case let .inactiveChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.pendingOpenChannel, .pendingOpenChannel): return {
						guard case let .pendingOpenChannel(l) = lhs, case let .pendingOpenChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.fullyResolvedChannel, .fullyResolvedChannel): return {
						guard case let .fullyResolvedChannel(l) = lhs, case let .fullyResolvedChannel(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_WalletBalanceResponse {
	...
	var accountBalance: [String: Lnrpc_WalletAccountBalance] = [:]
...
struct Lnrpc_ChannelBalanceResponse {
	...
	mutating func clearLocalBalance() { _localBalance = nil }
	...
	mutating func clearRemoteBalance() { _remoteBalance = nil }
	...
	mutating func clearUnsettledLocalBalance() { _unsettledLocalBalance = nil }
	...
	mutating func clearUnsettledRemoteBalance() { _unsettledRemoteBalance = nil }
	...
	mutating func clearPendingOpenLocalBalance() { _pendingOpenLocalBalance = nil }
	...
	mutating func clearPendingOpenRemoteBalance() { _pendingOpenRemoteBalance = nil }

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _localBalance: Lnrpc_Amount?
	fileprivate var _remoteBalance: Lnrpc_Amount?
	fileprivate var _unsettledLocalBalance: Lnrpc_Amount?
	fileprivate var _unsettledRemoteBalance: Lnrpc_Amount?
	fileprivate var _pendingOpenLocalBalance: Lnrpc_Amount?
	fileprivate var _pendingOpenRemoteBalance: Lnrpc_Amount?
}
...
struct Lnrpc_Hop {
	...
	mutating func clearMppRecord() { _mppRecord = nil }
	...
	mutating func clearAmpRecord() { _ampRecord = nil }

	///
	/// An optional set of key-value TLV records. This is useful within the context
	/// of the SendToRoute call as it allows callers to specify arbitrary K-V pairs
	/// to drop off at each hop within the onion.
	var customRecords: [UInt64: Data] = [:]

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _mppRecord: Lnrpc_MPPRecord?
	fileprivate var _ampRecord: Lnrpc_AMPRecord?
}
...
struct Lnrpc_NodeInfo {
	...
	fileprivate var _node: Lnrpc_LightningNode?
}
...
struct Lnrpc_NodeMetricsResponse {
	...
	var betweennessCentrality: [String: Lnrpc_FloatMetric] = [:]
...
struct Lnrpc_NodeUpdate {
	...
	var identityKey: String = .init()

	///
	/// Deprecated, use features.
	var globalFeatures: Data = .init()
...
struct Lnrpc_ChannelEdgeUpdate {
	...
	mutating func clearRoutingPolicy() { _routingPolicy = nil }

	var advertisingNode: String = .init()

	var connectingNode: String = .init()
	...
	fileprivate var _chanPoint: Lnrpc_ChannelPoint?
	fileprivate var _routingPolicy: Lnrpc_RoutingPolicy?
}
...
struct Lnrpc_Invoice {
	...
	/// given sub-invoice.
	var ampInvoiceState: [String: Lnrpc_AMPInvoiceState] {
...
struct Lnrpc_InvoiceHTLC {
	...
	mutating func clearAmp() { _amp = nil }

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _amp: Lnrpc_AMP?
}
...
struct Lnrpc_Payment {
	...
	var paymentPreimage: String = .init()
...
struct Lnrpc_HTLCAttempt {
	...
	mutating func clearFailure() { _failure = nil }
	...
	fileprivate var _route: Lnrpc_Route?
	fileprivate var _failure: Lnrpc_Failure?
}
...
struct Lnrpc_PayReq {
	...
	var descriptionHash: String = .init()

	var fallbackAddr: String = .init()
...
struct Lnrpc_PolicyUpdateRequest {
	...
	var scope: Lnrpc_PolicyUpdateRequest.OneOf_Scope?

	/// If set, then this update applies to all currently active channels.
	var global: Bool {
		get {
			if case let .global(v)? = scope { return v }
			return false
		}
	...
	var chanPoint: Lnrpc_ChannelPoint {
		get {
			if case let .chanPoint(v)? = scope { return v }
			return Lnrpc_ChannelPoint()
		}
		...
		case chanPoint(Lnrpc_ChannelPoint)
			...
			static func == (lhs: Lnrpc_PolicyUpdateRequest.OneOf_Scope, rhs: Lnrpc_PolicyUpdateRequest.OneOf_Scope) -> Bool {
				...
				case (.global, .global): return {
						guard case let .global(l) = lhs, case let .global(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.chanPoint, .chanPoint): return {
						guard case let .chanPoint(l) = lhs, case let .chanPoint(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_ChanBackupSnapshot {
	...
	mutating func clearSingleChanBackups() { _singleChanBackups = nil }
	...
	mutating func clearMultiChanBackup() { _multiChanBackup = nil }

	var unknownFields = SwiftProtobuf.UnknownStorage()

	init() {}

	fileprivate var _singleChanBackups: Lnrpc_ChannelBackups?
	fileprivate var _multiChanBackup: Lnrpc_MultiChanBackup?
}
...
struct Lnrpc_RestoreChanBackupRequest {
	...
	var backup: Lnrpc_RestoreChanBackupRequest.OneOf_Backup?

	///
	/// The channels to restore as a list of channel/backup pairs.
	var chanBackups: Lnrpc_ChannelBackups {
		get {
			if case let .chanBackups(v)? = backup { return v }
	...
	var multiChanBackup: Data {
		get {
			if case let .multiChanBackup(v)? = backup { return v }
			return Data()
		}
		...
		case multiChanBackup(Data)
			...
			static func == (lhs: Lnrpc_RestoreChanBackupRequest.OneOf_Backup, rhs: Lnrpc_RestoreChanBackupRequest.OneOf_Backup) -> Bool {
				...
				case (.chanBackups, .chanBackups): return {
						guard case let .chanBackups(l) = lhs, case let .chanBackups(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.multiChanBackup, .multiChanBackup): return {
						guard case let .multiChanBackup(l) = lhs, case let .multiChanBackup(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_ListPermissionsResponse {
	...
	/// access them.
	var methodPermissions: [String: Lnrpc_MacaroonPermissionList] = [:]
...
struct Lnrpc_CheckMacPermRequest {
	...
	var macaroon: Data = .init()

	var permissions: [Lnrpc_MacaroonPermission] = []

	var fullMethod: String = .init()
...
struct Lnrpc_RPCMiddlewareRequest {
	...
	var customCaveatCondition: String = .init()
	...
	var interceptType: Lnrpc_RPCMiddlewareRequest.OneOf_InterceptType?
	...
	var streamAuth: Lnrpc_StreamAuth {
		get {
			if case let .streamAuth(v)? = interceptType { return v }
	...
	var request: Lnrpc_RPCMessage {
		get {
			if case let .request(v)? = interceptType { return v }
	...
	var response: Lnrpc_RPCMessage {
		get {
			if case let .response(v)? = interceptType { return v }
			return Lnrpc_RPCMessage()
		}
		...
		case response(Lnrpc_RPCMessage)
			...
			static func == (lhs: Lnrpc_RPCMiddlewareRequest.OneOf_InterceptType, rhs: Lnrpc_RPCMiddlewareRequest.OneOf_InterceptType) -> Bool {
				...
				case (.streamAuth, .streamAuth): return {
						guard case let .streamAuth(l) = lhs, case let .streamAuth(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.request, .request): return {
						guard case let .request(l) = lhs, case let .request(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.response, .response): return {
						guard case let .response(l) = lhs, case let .response(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_RPCMiddlewareResponse {
	...
	var middlewareMessage: Lnrpc_RPCMiddlewareResponse.OneOf_MiddlewareMessage?
	...
	var register: Lnrpc_MiddlewareRegistration {
		get {
			if case let .register(v)? = middlewareMessage { return v }
	...
	var feedback: Lnrpc_InterceptFeedback {
		get {
			if case let .feedback(v)? = middlewareMessage { return v }
		...
		case feedback(Lnrpc_InterceptFeedback)
			...
			static func == (lhs: Lnrpc_RPCMiddlewareResponse.OneOf_MiddlewareMessage, rhs: Lnrpc_RPCMiddlewareResponse.OneOf_MiddlewareMessage) -> Bool {
				...
				case (.register, .register): return {
						guard case let .register(l) = lhs, case let .register(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				case (.feedback, .feedback): return {
						guard case let .feedback(l) = lhs, case let .feedback(r) = rhs else { preconditionFailure() }
						return l == r
					}()
				default: return false
				}
...
struct Lnrpc_MiddlewareRegistration {
	...
	var middlewareName: String = .init()
	...
	var customMacaroonCaveatName: String = .init()
...
struct Lnrpc_InterceptFeedback {
	...
	var replacementSerialized: Data = .init()
...
extension Lnrpc_CustomMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &peer)
			case 2: try decoder.decodeSingularUInt32Field(value: &type)
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !peer.isEmpty {
			try visitor.visitSingularBytesField(value: peer, fieldNumber: 1)
		}
		if type != 0 {
			try visitor.visitSingularUInt32Field(value: type, fieldNumber: 2)
		}
		if !data.isEmpty {
...
extension Lnrpc_Utxo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularEnumField(value: &addressType)
			case 2: try decoder.decodeSingularStringField(value: &address)
			case 3: try decoder.decodeSingularInt64Field(value: &amountSat)
			case 4: try decoder.decodeSingularStringField(value: &pkScript)
			case 5: try decoder.decodeSingularMessageField(value: &_outpoint)
			case 6: try decoder.decodeSingularInt64Field(value: &confirmations)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if addressType != .witnessPubkeyHash {
			try visitor.visitSingularEnumField(value: addressType, fieldNumber: 1)
		}
		if !address.isEmpty {
			try visitor.visitSingularStringField(value: address, fieldNumber: 2)
		}
		if amountSat != 0 {
			try visitor.visitSingularInt64Field(value: amountSat, fieldNumber: 3)
		}
		if !pkScript.isEmpty {
			try visitor.visitSingularStringField(value: pkScript, fieldNumber: 4)
		}
		try { if let v = self._outpoint {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
		} }()
		if confirmations != 0 {
			try visitor.visitSingularInt64Field(value: confirmations, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 3: try decoder.decodeSingularInt32Field(value: &numConfirmations)
			case 4: try decoder.decodeSingularStringField(value: &blockHash)
			case 5: try decoder.decodeSingularInt32Field(value: &blockHeight)
			case 6: try decoder.decodeSingularInt64Field(value: &timeStamp)
			case 7: try decoder.decodeSingularInt64Field(value: &totalFees)
			case 8: try decoder.decodeRepeatedStringField(value: &destAddresses)
			case 9: try decoder.decodeSingularStringField(value: &rawTxHex)
			case 10: try decoder.decodeSingularStringField(value: &label)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if numConfirmations != 0 {
			try visitor.visitSingularInt32Field(value: numConfirmations, fieldNumber: 3)
		}
		if !blockHash.isEmpty {
			try visitor.visitSingularStringField(value: blockHash, fieldNumber: 4)
		}
		if blockHeight != 0 {
			try visitor.visitSingularInt32Field(value: blockHeight, fieldNumber: 5)
		}
		if timeStamp != 0 {
			try visitor.visitSingularInt64Field(value: timeStamp, fieldNumber: 6)
		}
		if totalFees != 0 {
			try visitor.visitSingularInt64Field(value: totalFees, fieldNumber: 7)
		}
		if !destAddresses.isEmpty {
			try visitor.visitRepeatedStringField(value: destAddresses, fieldNumber: 8)
		}
		if !rawTxHex.isEmpty {
			try visitor.visitSingularStringField(value: rawTxHex, fieldNumber: 9)
		}
		if !label.isEmpty {
			try visitor.visitSingularStringField(value: label, fieldNumber: 10)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_GetTransactionsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt32Field(value: &startHeight)
			case 2: try decoder.decodeSingularInt32Field(value: &endHeight)
			case 3: try decoder.decodeSingularStringField(value: &account)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if startHeight != 0 {
			try visitor.visitSingularInt32Field(value: startHeight, fieldNumber: 1)
		}
		if endHeight != 0 {
			try visitor.visitSingularInt32Field(value: endHeight, fieldNumber: 2)
		}
		if !account.isEmpty {
			try visitor.visitSingularStringField(value: account, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FeeLimit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		switch limit {
		case .fixed?: try {
				guard case let .fixed(v)? = self.limit else { preconditionFailure() }
				try visitor.visitSingularInt64Field(value: v, fieldNumber: 1)
			}()
		case .percent?: try {
				guard case let .percent(v)? = self.limit else { preconditionFailure() }
				try visitor.visitSingularInt64Field(value: v, fieldNumber: 2)
			}()
		case .fixedMsat?: try {
				guard case let .fixedMsat(v)? = self.limit else { preconditionFailure() }
...
extension Lnrpc_SendRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &dest)
			case 2: try decoder.decodeSingularStringField(value: &destString)
			case 3: try decoder.decodeSingularInt64Field(value: &amt)
			case 4: try decoder.decodeSingularBytesField(value: &paymentHash)
			case 5: try decoder.decodeSingularStringField(value: &paymentHashString)
			case 6: try decoder.decodeSingularStringField(value: &paymentRequest)
			case 7: try decoder.decodeSingularInt32Field(value: &finalCltvDelta)
			case 8: try decoder.decodeSingularMessageField(value: &_feeLimit)
			case 9: try decoder.decodeSingularUInt64Field(value: &outgoingChanID)
			case 10: try decoder.decodeSingularUInt32Field(value: &cltvLimit)
			case 11: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: &destCustomRecords)
			case 12: try decoder.decodeSingularInt64Field(value: &amtMsat)
			case 13: try decoder.decodeSingularBytesField(value: &lastHopPubkey)
			case 14: try decoder.decodeSingularBoolField(value: &allowSelfPayment)
			case 15: try decoder.decodeRepeatedEnumField(value: &destFeatures)
			case 16: try decoder.decodeSingularBytesField(value: &paymentAddr)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if !dest.isEmpty {
			try visitor.visitSingularBytesField(value: dest, fieldNumber: 1)
		}
		if !destString.isEmpty {
			try visitor.visitSingularStringField(value: destString, fieldNumber: 2)
		}
		if amt != 0 {
			try visitor.visitSingularInt64Field(value: amt, fieldNumber: 3)
		}
		if !paymentHash.isEmpty {
			try visitor.visitSingularBytesField(value: paymentHash, fieldNumber: 4)
		}
		if !paymentHashString.isEmpty {
			try visitor.visitSingularStringField(value: paymentHashString, fieldNumber: 5)
		}
		if !paymentRequest.isEmpty {
			try visitor.visitSingularStringField(value: paymentRequest, fieldNumber: 6)
		}
		if finalCltvDelta != 0 {
			try visitor.visitSingularInt32Field(value: finalCltvDelta, fieldNumber: 7)
		}
		try { if let v = self._feeLimit {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
		} }()
		if outgoingChanID != 0 {
			try visitor.visitSingularUInt64Field(value: outgoingChanID, fieldNumber: 9)
		}
		if cltvLimit != 0 {
			try visitor.visitSingularUInt32Field(value: cltvLimit, fieldNumber: 10)
		}
		if !destCustomRecords.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: destCustomRecords, fieldNumber: 11)
		}
		if amtMsat != 0 {
			try visitor.visitSingularInt64Field(value: amtMsat, fieldNumber: 12)
		}
		if !lastHopPubkey.isEmpty {
			try visitor.visitSingularBytesField(value: lastHopPubkey, fieldNumber: 13)
		}
		if allowSelfPayment != false {
			try visitor.visitSingularBoolField(value: allowSelfPayment, fieldNumber: 14)
		}
		if !destFeatures.isEmpty {
			try visitor.visitPackedEnumField(value: destFeatures, fieldNumber: 15)
		}
		if !paymentAddr.isEmpty {
			try visitor.visitSingularBytesField(value: paymentAddr, fieldNumber: 16)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SendResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &paymentError)
			case 2: try decoder.decodeSingularBytesField(value: &paymentPreimage)
			case 3: try decoder.decodeSingularMessageField(value: &_paymentRoute)
			case 4: try decoder.decodeSingularBytesField(value: &paymentHash)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !paymentError.isEmpty {
			try visitor.visitSingularStringField(value: paymentError, fieldNumber: 1)
		}
		if !paymentPreimage.isEmpty {
			try visitor.visitSingularBytesField(value: paymentPreimage, fieldNumber: 2)
		}
...
extension Lnrpc_SendToRouteRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &paymentHash)
			case 2: try decoder.decodeSingularStringField(value: &paymentHashString)
			case 4: try decoder.decodeSingularMessageField(value: &_route)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if !paymentHash.isEmpty {
			try visitor.visitSingularBytesField(value: paymentHash, fieldNumber: 1)
		}
		if !paymentHashString.isEmpty {
			try visitor.visitSingularStringField(value: paymentHashString, fieldNumber: 2)
		}
...
extension Lnrpc_ChannelAcceptRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &nodePubkey)
			case 2: try decoder.decodeSingularBytesField(value: &chainHash)
			case 3: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 4: try decoder.decodeSingularUInt64Field(value: &fundingAmt)
			case 5: try decoder.decodeSingularUInt64Field(value: &pushAmt)
			case 6: try decoder.decodeSingularUInt64Field(value: &dustLimit)
			case 7: try decoder.decodeSingularUInt64Field(value: &maxValueInFlight)
			case 8: try decoder.decodeSingularUInt64Field(value: &channelReserve)
			case 9: try decoder.decodeSingularUInt64Field(value: &minHtlc)
			case 10: try decoder.decodeSingularUInt64Field(value: &feePerKw)
			case 11: try decoder.decodeSingularUInt32Field(value: &csvDelay)
			case 12: try decoder.decodeSingularUInt32Field(value: &maxAcceptedHtlcs)
			case 13: try decoder.decodeSingularUInt32Field(value: &channelFlags)
			case 14: try decoder.decodeSingularEnumField(value: &commitmentType)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !nodePubkey.isEmpty {
			try visitor.visitSingularBytesField(value: nodePubkey, fieldNumber: 1)
		}
		if !chainHash.isEmpty {
			try visitor.visitSingularBytesField(value: chainHash, fieldNumber: 2)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 3)
		}
		if fundingAmt != 0 {
			try visitor.visitSingularUInt64Field(value: fundingAmt, fieldNumber: 4)
		}
		if pushAmt != 0 {
			try visitor.visitSingularUInt64Field(value: pushAmt, fieldNumber: 5)
		}
		if dustLimit != 0 {
			try visitor.visitSingularUInt64Field(value: dustLimit, fieldNumber: 6)
		}
		if maxValueInFlight != 0 {
			try visitor.visitSingularUInt64Field(value: maxValueInFlight, fieldNumber: 7)
		}
		if channelReserve != 0 {
			try visitor.visitSingularUInt64Field(value: channelReserve, fieldNumber: 8)
		}
		if minHtlc != 0 {
			try visitor.visitSingularUInt64Field(value: minHtlc, fieldNumber: 9)
		}
		if feePerKw != 0 {
			try visitor.visitSingularUInt64Field(value: feePerKw, fieldNumber: 10)
		}
		if csvDelay != 0 {
			try visitor.visitSingularUInt32Field(value: csvDelay, fieldNumber: 11)
		}
		if maxAcceptedHtlcs != 0 {
			try visitor.visitSingularUInt32Field(value: maxAcceptedHtlcs, fieldNumber: 12)
		}
		if channelFlags != 0 {
			try visitor.visitSingularUInt32Field(value: channelFlags, fieldNumber: 13)
		}
		if commitmentType != .unknownCommitmentType {
			try visitor.visitSingularEnumField(value: commitmentType, fieldNumber: 14)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelAcceptResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &accept)
			case 2: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 3: try decoder.decodeSingularStringField(value: &error)
			case 4: try decoder.decodeSingularStringField(value: &upfrontShutdown)
			case 5: try decoder.decodeSingularUInt32Field(value: &csvDelay)
			case 6: try decoder.decodeSingularUInt64Field(value: &reserveSat)
			case 7: try decoder.decodeSingularUInt64Field(value: &inFlightMaxMsat)
			case 8: try decoder.decodeSingularUInt32Field(value: &maxHtlcCount)
			case 9: try decoder.decodeSingularUInt64Field(value: &minHtlcIn)
			case 10: try decoder.decodeSingularUInt32Field(value: &minAcceptDepth)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if accept != false {
			try visitor.visitSingularBoolField(value: accept, fieldNumber: 1)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 2)
		}
		if !error.isEmpty {
			try visitor.visitSingularStringField(value: error, fieldNumber: 3)
		}
		if !upfrontShutdown.isEmpty {
			try visitor.visitSingularStringField(value: upfrontShutdown, fieldNumber: 4)
		}
		if csvDelay != 0 {
			try visitor.visitSingularUInt32Field(value: csvDelay, fieldNumber: 5)
		}
		if reserveSat != 0 {
			try visitor.visitSingularUInt64Field(value: reserveSat, fieldNumber: 6)
		}
		if inFlightMaxMsat != 0 {
			try visitor.visitSingularUInt64Field(value: inFlightMaxMsat, fieldNumber: 7)
		}
		if maxHtlcCount != 0 {
			try visitor.visitSingularUInt32Field(value: maxHtlcCount, fieldNumber: 8)
		}
		if minHtlcIn != 0 {
			try visitor.visitSingularUInt64Field(value: minHtlcIn, fieldNumber: 9)
		}
		if minAcceptDepth != 0 {
			try visitor.visitSingularUInt32Field(value: minAcceptDepth, fieldNumber: 10)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 3: try decoder.decodeSingularUInt32Field(value: &outputIndex)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .fundingTxidBytes?: try {
				guard case let .fundingTxidBytes(v)? = self.fundingTxid else { preconditionFailure() }
				try visitor.visitSingularBytesField(value: v, fieldNumber: 1)
			}()
		case .fundingTxidStr?: try {
				guard case let .fundingTxidStr(v)? = self.fundingTxid else { preconditionFailure() }
				try visitor.visitSingularStringField(value: v, fieldNumber: 2)
			}()
		case nil: break
		}
		if outputIndex != 0 {
			try visitor.visitSingularUInt32Field(value: outputIndex, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_OutPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &txidBytes)
			case 2: try decoder.decodeSingularStringField(value: &txidStr)
			case 3: try decoder.decodeSingularUInt32Field(value: &outputIndex)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !txidBytes.isEmpty {
			try visitor.visitSingularBytesField(value: txidBytes, fieldNumber: 1)
		}
		if !txidStr.isEmpty {
			try visitor.visitSingularStringField(value: txidStr, fieldNumber: 2)
		}
		if outputIndex != 0 {
			try visitor.visitSingularUInt32Field(value: outputIndex, fieldNumber: 3)
		}
...
extension Lnrpc_LightningAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &pubkey)
			case 2: try decoder.decodeSingularStringField(value: &host)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !pubkey.isEmpty {
			try visitor.visitSingularStringField(value: pubkey, fieldNumber: 1)
		}
		if !host.isEmpty {
			try visitor.visitSingularStringField(value: host, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_EstimateFeeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufInt64>.self, value: &addrToAmount)
			case 2: try decoder.decodeSingularInt32Field(value: &targetConf)
			case 3: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 4: try decoder.decodeSingularBoolField(value: &spendUnconfirmed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !addrToAmount.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufInt64>.self, value: addrToAmount, fieldNumber: 1)
		}
		if targetConf != 0 {
			try visitor.visitSingularInt32Field(value: targetConf, fieldNumber: 2)
		}
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 3)
		}
		if spendUnconfirmed != false {
			try visitor.visitSingularBoolField(value: spendUnconfirmed, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_EstimateFeeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &feeSat)
			case 2: try decoder.decodeSingularInt64Field(value: &feerateSatPerByte)
			case 3: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if feeSat != 0 {
			try visitor.visitSingularInt64Field(value: feeSat, fieldNumber: 1)
		}
		if feerateSatPerByte != 0 {
			try visitor.visitSingularInt64Field(value: feerateSatPerByte, fieldNumber: 2)
		}
		if satPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: satPerVbyte, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SendManyRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufInt64>.self, value: &addrToAmount)
			case 3: try decoder.decodeSingularInt32Field(value: &targetConf)
			case 4: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			case 5: try decoder.decodeSingularInt64Field(value: &satPerByte)
			case 6: try decoder.decodeSingularStringField(value: &label)
			case 7: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 8: try decoder.decodeSingularBoolField(value: &spendUnconfirmed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if targetConf != 0 {
			try visitor.visitSingularInt32Field(value: targetConf, fieldNumber: 3)
		}
		if satPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: satPerVbyte, fieldNumber: 4)
		}
		if satPerByte != 0 {
			try visitor.visitSingularInt64Field(value: satPerByte, fieldNumber: 5)
		}
		if !label.isEmpty {
			try visitor.visitSingularStringField(value: label, fieldNumber: 6)
		}
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 7)
		}
		if spendUnconfirmed != false {
			try visitor.visitSingularBoolField(value: spendUnconfirmed, fieldNumber: 8)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SendManyResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &txid)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !txid.isEmpty {
			try visitor.visitSingularStringField(value: txid, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SendCoinsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &addr)
			case 2: try decoder.decodeSingularInt64Field(value: &amount)
			case 3: try decoder.decodeSingularInt32Field(value: &targetConf)
			case 4: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			case 5: try decoder.decodeSingularInt64Field(value: &satPerByte)
			case 6: try decoder.decodeSingularBoolField(value: &sendAll)
			case 7: try decoder.decodeSingularStringField(value: &label)
			case 8: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 9: try decoder.decodeSingularBoolField(value: &spendUnconfirmed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !addr.isEmpty {
			try visitor.visitSingularStringField(value: addr, fieldNumber: 1)
		}
		if amount != 0 {
			try visitor.visitSingularInt64Field(value: amount, fieldNumber: 2)
		}
		...
		if sendAll != false {
			try visitor.visitSingularBoolField(value: sendAll, fieldNumber: 6)
		}
		if !label.isEmpty {
			try visitor.visitSingularStringField(value: label, fieldNumber: 7)
		}
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 8)
		}
		if spendUnconfirmed != false {
			try visitor.visitSingularBoolField(value: spendUnconfirmed, fieldNumber: 9)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListUnspentRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 2: try decoder.decodeSingularInt32Field(value: &maxConfs)
			case 3: try decoder.decodeSingularStringField(value: &account)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 1)
		}
		if maxConfs != 0 {
			try visitor.visitSingularInt32Field(value: maxConfs, fieldNumber: 2)
		}
		if !account.isEmpty {
			try visitor.visitSingularStringField(value: account, fieldNumber: 3)
		}
...
extension Lnrpc_ListUnspentResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &utxos)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !utxos.isEmpty {
			try visitor.visitRepeatedMessageField(value: utxos, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NewAddressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &account)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if type != .witnessPubkeyHash {
			try visitor.visitSingularEnumField(value: type, fieldNumber: 1)
		}
		if !account.isEmpty {
			try visitor.visitSingularStringField(value: account, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SignMessageRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularBoolField(value: &singleHash)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if singleHash != false {
			try visitor.visitSingularBoolField(value: singleHash, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SignMessageResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &signature)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !signature.isEmpty {
			try visitor.visitSingularStringField(value: signature, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_VerifyMessageRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &msg)
			case 2: try decoder.decodeSingularStringField(value: &signature)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !signature.isEmpty {
			try visitor.visitSingularStringField(value: signature, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_VerifyMessageResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &pubkey)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !pubkey.isEmpty {
			try visitor.visitSingularStringField(value: pubkey, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ConnectPeerRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_addr)
			case 2: try decoder.decodeSingularBoolField(value: &perm)
			case 3: try decoder.decodeSingularUInt64Field(value: &timeout)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if perm != false {
			try visitor.visitSingularBoolField(value: perm, fieldNumber: 2)
		}
		if timeout != 0 {
			try visitor.visitSingularUInt64Field(value: timeout, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_HTLC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &incoming)
			case 2: try decoder.decodeSingularInt64Field(value: &amount)
			case 3: try decoder.decodeSingularBytesField(value: &hashLock)
			case 4: try decoder.decodeSingularUInt32Field(value: &expirationHeight)
			case 5: try decoder.decodeSingularUInt64Field(value: &htlcIndex)
			case 6: try decoder.decodeSingularUInt64Field(value: &forwardingChannel)
			case 7: try decoder.decodeSingularUInt64Field(value: &forwardingHtlcIndex)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if incoming != false {
			try visitor.visitSingularBoolField(value: incoming, fieldNumber: 1)
		}
		if amount != 0 {
			try visitor.visitSingularInt64Field(value: amount, fieldNumber: 2)
		}
		if !hashLock.isEmpty {
			try visitor.visitSingularBytesField(value: hashLock, fieldNumber: 3)
		}
		if expirationHeight != 0 {
			try visitor.visitSingularUInt32Field(value: expirationHeight, fieldNumber: 4)
		}
		if htlcIndex != 0 {
			try visitor.visitSingularUInt64Field(value: htlcIndex, fieldNumber: 5)
		}
		if forwardingChannel != 0 {
			try visitor.visitSingularUInt64Field(value: forwardingChannel, fieldNumber: 6)
		}
		if forwardingHtlcIndex != 0 {
			try visitor.visitSingularUInt64Field(value: forwardingHtlcIndex, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelConstraints: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &csvDelay)
			case 2: try decoder.decodeSingularUInt64Field(value: &chanReserveSat)
			case 3: try decoder.decodeSingularUInt64Field(value: &dustLimitSat)
			case 4: try decoder.decodeSingularUInt64Field(value: &maxPendingAmtMsat)
			case 5: try decoder.decodeSingularUInt64Field(value: &minHtlcMsat)
			case 6: try decoder.decodeSingularUInt32Field(value: &maxAcceptedHtlcs)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if csvDelay != 0 {
			try visitor.visitSingularUInt32Field(value: csvDelay, fieldNumber: 1)
		}
		if chanReserveSat != 0 {
			try visitor.visitSingularUInt64Field(value: chanReserveSat, fieldNumber: 2)
		}
		if dustLimitSat != 0 {
			try visitor.visitSingularUInt64Field(value: dustLimitSat, fieldNumber: 3)
		}
		if maxPendingAmtMsat != 0 {
			try visitor.visitSingularUInt64Field(value: maxPendingAmtMsat, fieldNumber: 4)
		}
		if minHtlcMsat != 0 {
			try visitor.visitSingularUInt64Field(value: minHtlcMsat, fieldNumber: 5)
		}
		if maxAcceptedHtlcs != 0 {
			try visitor.visitSingularUInt32Field(value: maxAcceptedHtlcs, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Channel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		...
		var _remotePubkey: String = .init()
		var _channelPoint: String = .init()
		...
		var _chanStatusFlags: String = .init()
		...
		var _uptime: Int64 = 0
		var _closeAddress: String = .init()
		var _pushAmountSat: UInt64 = 0
		var _thawHeight: UInt32 = 0
		var _localConstraints: Lnrpc_ChannelConstraints?
		var _remoteConstraints: Lnrpc_ChannelConstraints?
...
extension Lnrpc_ListChannelsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &activeOnly)
			case 2: try decoder.decodeSingularBoolField(value: &inactiveOnly)
			case 3: try decoder.decodeSingularBoolField(value: &publicOnly)
			case 4: try decoder.decodeSingularBoolField(value: &privateOnly)
			case 5: try decoder.decodeSingularBytesField(value: &peer)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if activeOnly != false {
			try visitor.visitSingularBoolField(value: activeOnly, fieldNumber: 1)
		}
		if inactiveOnly != false {
			try visitor.visitSingularBoolField(value: inactiveOnly, fieldNumber: 2)
		}
		if publicOnly != false {
			try visitor.visitSingularBoolField(value: publicOnly, fieldNumber: 3)
		}
		if privateOnly != false {
			try visitor.visitSingularBoolField(value: privateOnly, fieldNumber: 4)
		}
		if !peer.isEmpty {
			try visitor.visitSingularBytesField(value: peer, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListChannelsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 11: try decoder.decodeRepeatedMessageField(value: &channels)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !channels.isEmpty {
			try visitor.visitRepeatedMessageField(value: channels, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelCloseSummary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &channelPoint)
			case 2: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 3: try decoder.decodeSingularStringField(value: &chainHash)
			case 4: try decoder.decodeSingularStringField(value: &closingTxHash)
			case 5: try decoder.decodeSingularStringField(value: &remotePubkey)
			case 6: try decoder.decodeSingularInt64Field(value: &capacity)
			case 7: try decoder.decodeSingularUInt32Field(value: &closeHeight)
			case 8: try decoder.decodeSingularInt64Field(value: &settledBalance)
			case 9: try decoder.decodeSingularInt64Field(value: &timeLockedBalance)
			case 10: try decoder.decodeSingularEnumField(value: &closeType)
			case 11: try decoder.decodeSingularEnumField(value: &openInitiator)
			case 12: try decoder.decodeSingularEnumField(value: &closeInitiator)
			case 13: try decoder.decodeRepeatedMessageField(value: &resolutions)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !channelPoint.isEmpty {
			try visitor.visitSingularStringField(value: channelPoint, fieldNumber: 1)
		}
		if chanID != 0 {
			try visitor.visitSingularUInt64Field(value: chanID, fieldNumber: 2)
		}
		if !chainHash.isEmpty {
			try visitor.visitSingularStringField(value: chainHash, fieldNumber: 3)
		}
		if !closingTxHash.isEmpty {
			try visitor.visitSingularStringField(value: closingTxHash, fieldNumber: 4)
		}
		if !remotePubkey.isEmpty {
			try visitor.visitSingularStringField(value: remotePubkey, fieldNumber: 5)
		}
		if capacity != 0 {
			try visitor.visitSingularInt64Field(value: capacity, fieldNumber: 6)
		}
		if closeHeight != 0 {
			try visitor.visitSingularUInt32Field(value: closeHeight, fieldNumber: 7)
		}
		if settledBalance != 0 {
			try visitor.visitSingularInt64Field(value: settledBalance, fieldNumber: 8)
		}
		if timeLockedBalance != 0 {
			try visitor.visitSingularInt64Field(value: timeLockedBalance, fieldNumber: 9)
		}
		if closeType != .cooperativeClose {
			try visitor.visitSingularEnumField(value: closeType, fieldNumber: 10)
		}
		if openInitiator != .unknown {
			try visitor.visitSingularEnumField(value: openInitiator, fieldNumber: 11)
		}
		if closeInitiator != .unknown {
			try visitor.visitSingularEnumField(value: closeInitiator, fieldNumber: 12)
		}
		if !resolutions.isEmpty {
			try visitor.visitRepeatedMessageField(value: resolutions, fieldNumber: 13)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Resolution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularEnumField(value: &resolutionType)
			case 2: try decoder.decodeSingularEnumField(value: &outcome)
			case 3: try decoder.decodeSingularMessageField(value: &_outpoint)
			case 4: try decoder.decodeSingularUInt64Field(value: &amountSat)
			case 5: try decoder.decodeSingularStringField(value: &sweepTxid)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
		// https://github.com/apple/swift-protobuf/issues/1182
		if resolutionType != .typeUnknown {
			try visitor.visitSingularEnumField(value: resolutionType, fieldNumber: 1)
		}
		if outcome != .outcomeUnknown {
			try visitor.visitSingularEnumField(value: outcome, fieldNumber: 2)
		}
		try { if let v = self._outpoint {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
		} }()
		if amountSat != 0 {
			try visitor.visitSingularUInt64Field(value: amountSat, fieldNumber: 4)
		}
		if !sweepTxid.isEmpty {
			try visitor.visitSingularStringField(value: sweepTxid, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ClosedChannelsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &cooperative)
			case 2: try decoder.decodeSingularBoolField(value: &localForce)
			case 3: try decoder.decodeSingularBoolField(value: &remoteForce)
			case 4: try decoder.decodeSingularBoolField(value: &breach)
			case 5: try decoder.decodeSingularBoolField(value: &fundingCanceled)
			case 6: try decoder.decodeSingularBoolField(value: &abandoned)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if cooperative != false {
			try visitor.visitSingularBoolField(value: cooperative, fieldNumber: 1)
		}
		if localForce != false {
			try visitor.visitSingularBoolField(value: localForce, fieldNumber: 2)
		}
		if remoteForce != false {
			try visitor.visitSingularBoolField(value: remoteForce, fieldNumber: 3)
		}
		if breach != false {
			try visitor.visitSingularBoolField(value: breach, fieldNumber: 4)
		}
		if fundingCanceled != false {
			try visitor.visitSingularBoolField(value: fundingCanceled, fieldNumber: 5)
		}
		if abandoned != false {
			try visitor.visitSingularBoolField(value: abandoned, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Peer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &pubKey)
			case 3: try decoder.decodeSingularStringField(value: &address)
			case 4: try decoder.decodeSingularUInt64Field(value: &bytesSent)
			case 5: try decoder.decodeSingularUInt64Field(value: &bytesRecv)
			case 6: try decoder.decodeSingularInt64Field(value: &satSent)
			case 7: try decoder.decodeSingularInt64Field(value: &satRecv)
			case 8: try decoder.decodeSingularBoolField(value: &inbound)
			case 9: try decoder.decodeSingularInt64Field(value: &pingTime)
			case 10: try decoder.decodeSingularEnumField(value: &syncType)
			case 11: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: &features)
			case 12: try decoder.decodeRepeatedMessageField(value: &errors)
			case 13: try decoder.decodeSingularInt32Field(value: &flapCount)
			case 14: try decoder.decodeSingularInt64Field(value: &lastFlapNs)
			case 15: try decoder.decodeSingularBytesField(value: &lastPingPayload)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !address.isEmpty {
			try visitor.visitSingularStringField(value: address, fieldNumber: 3)
		}
		if bytesSent != 0 {
			try visitor.visitSingularUInt64Field(value: bytesSent, fieldNumber: 4)
		}
		if bytesRecv != 0 {
			try visitor.visitSingularUInt64Field(value: bytesRecv, fieldNumber: 5)
		}
		if satSent != 0 {
			try visitor.visitSingularInt64Field(value: satSent, fieldNumber: 6)
		}
		if satRecv != 0 {
			try visitor.visitSingularInt64Field(value: satRecv, fieldNumber: 7)
		}
		if inbound != false {
			try visitor.visitSingularBoolField(value: inbound, fieldNumber: 8)
		}
		if pingTime != 0 {
			try visitor.visitSingularInt64Field(value: pingTime, fieldNumber: 9)
		}
		if syncType != .unknownSync {
			try visitor.visitSingularEnumField(value: syncType, fieldNumber: 10)
		}
		if !features.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: features, fieldNumber: 11)
		}
		if !errors.isEmpty {
			try visitor.visitRepeatedMessageField(value: errors, fieldNumber: 12)
		}
		if flapCount != 0 {
			try visitor.visitSingularInt32Field(value: flapCount, fieldNumber: 13)
		}
		if lastFlapNs != 0 {
			try visitor.visitSingularInt64Field(value: lastFlapNs, fieldNumber: 14)
		}
		if !lastPingPayload.isEmpty {
			try visitor.visitSingularBytesField(value: lastPingPayload, fieldNumber: 15)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_TimestampedError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &timestamp)
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !error.isEmpty {
			try visitor.visitSingularStringField(value: error, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListPeersRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &latestError)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if latestError != false {
			try visitor.visitSingularBoolField(value: latestError, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListPeersResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &peers)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !peers.isEmpty {
			try visitor.visitRepeatedMessageField(value: peers, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_GetInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		var _version: String = .init()
		var _commitHash: String = .init()
		var _identityPubkey: String = .init()
		var _alias: String = .init()
		var _color: String = .init()
		...
		var _uris: [String] = []
		var _features: [UInt32: Lnrpc_Feature] = [:]
...
extension Lnrpc_GetRecoveryInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &recoveryMode)
			case 2: try decoder.decodeSingularBoolField(value: &recoveryFinished)
			case 3: try decoder.decodeSingularDoubleField(value: &progress)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if recoveryMode != false {
			try visitor.visitSingularBoolField(value: recoveryMode, fieldNumber: 1)
		}
		if recoveryFinished != false {
			try visitor.visitSingularBoolField(value: recoveryFinished, fieldNumber: 2)
		}
		if progress != 0 {
			try visitor.visitSingularDoubleField(value: progress, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Chain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &network)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !network.isEmpty {
			try visitor.visitSingularStringField(value: network, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ConfirmationUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &blockSha)
			case 2: try decoder.decodeSingularInt32Field(value: &blockHeight)
			case 3: try decoder.decodeSingularUInt32Field(value: &numConfsLeft)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !blockSha.isEmpty {
			try visitor.visitSingularBytesField(value: blockSha, fieldNumber: 1)
		}
		if blockHeight != 0 {
			try visitor.visitSingularInt32Field(value: blockHeight, fieldNumber: 2)
		}
		if numConfsLeft != 0 {
			try visitor.visitSingularUInt32Field(value: numConfsLeft, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelOpenUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_channelPoint)
			default: break
			}
		}
	}
...
extension Lnrpc_ChannelCloseUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &closingTxid)
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !closingTxid.isEmpty {
			try visitor.visitSingularBytesField(value: closingTxid, fieldNumber: 1)
		}
		if success != false {
...
extension Lnrpc_CloseChannelRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 3: try decoder.decodeSingularInt32Field(value: &targetConf)
			case 4: try decoder.decodeSingularInt64Field(value: &satPerByte)
			case 5: try decoder.decodeSingularStringField(value: &deliveryAddress)
			case 6: try decoder.decodeSingularUInt64Field(value: &satPerVbyte)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if satPerByte != 0 {
			try visitor.visitSingularInt64Field(value: satPerByte, fieldNumber: 4)
		}
		if !deliveryAddress.isEmpty {
			try visitor.visitSingularStringField(value: deliveryAddress, fieldNumber: 5)
		}
		if satPerVbyte != 0 {
			try visitor.visitSingularUInt64Field(value: satPerVbyte, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_CloseStatusUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.update {
						hadOneofValue = true
						if case let .closePending(m) = current { v = m }
					}
			...
			case 3: try {
					...
					if let current = self.update {
						hadOneofValue = true
						if case let .chanClose(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .closePending?: try {
				guard case let .closePending(v)? = self.update else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .chanClose?: try {
				guard case let .chanClose(v)? = self.update else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
			}()
		case nil: break
		}
...
extension Lnrpc_ReadyForPsbtFunding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &fundingAddress)
			case 2: try decoder.decodeSingularInt64Field(value: &fundingAmount)
			case 3: try decoder.decodeSingularBytesField(value: &psbt)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !fundingAddress.isEmpty {
			try visitor.visitSingularStringField(value: fundingAddress, fieldNumber: 1)
		}
		if fundingAmount != 0 {
			try visitor.visitSingularInt64Field(value: fundingAmount, fieldNumber: 2)
		}
		if !psbt.isEmpty {
			try visitor.visitSingularBytesField(value: psbt, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_BatchOpenChannelRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try decoder.decodeRepeatedMessageField(value: &channels)
			case 2: try decoder.decodeSingularInt32Field(value: &targetConf)
			case 3: try decoder.decodeSingularInt64Field(value: &satPerVbyte)
			case 4: try decoder.decodeSingularInt32Field(value: &minConfs)
			case 5: try decoder.decodeSingularBoolField(value: &spendUnconfirmed)
			case 6: try decoder.decodeSingularStringField(value: &label)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if satPerVbyte != 0 {
			try visitor.visitSingularInt64Field(value: satPerVbyte, fieldNumber: 3)
		}
		if minConfs != 0 {
			try visitor.visitSingularInt32Field(value: minConfs, fieldNumber: 4)
		}
		if spendUnconfirmed != false {
			try visitor.visitSingularBoolField(value: spendUnconfirmed, fieldNumber: 5)
		}
		if !label.isEmpty {
			try visitor.visitSingularStringField(value: label, fieldNumber: 6)
		}
...
extension Lnrpc_BatchOpenChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &nodePubkey)
			case 2: try decoder.decodeSingularInt64Field(value: &localFundingAmount)
			case 3: try decoder.decodeSingularInt64Field(value: &pushSat)
			case 4: try decoder.decodeSingularBoolField(value: &self.private)
			case 5: try decoder.decodeSingularInt64Field(value: &minHtlcMsat)
			case 6: try decoder.decodeSingularUInt32Field(value: &remoteCsvDelay)
			case 7: try decoder.decodeSingularStringField(value: &closeAddress)
			case 8: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 9: try decoder.decodeSingularEnumField(value: &commitmentType)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if localFundingAmount != 0 {
			try visitor.visitSingularInt64Field(value: localFundingAmount, fieldNumber: 2)
		}
		if pushSat != 0 {
			try visitor.visitSingularInt64Field(value: pushSat, fieldNumber: 3)
		}
		if self.private != false {
			try visitor.visitSingularBoolField(value: self.private, fieldNumber: 4)
		}
		if minHtlcMsat != 0 {
			try visitor.visitSingularInt64Field(value: minHtlcMsat, fieldNumber: 5)
		}
		if remoteCsvDelay != 0 {
			try visitor.visitSingularUInt32Field(value: remoteCsvDelay, fieldNumber: 6)
		}
		if !closeAddress.isEmpty {
			try visitor.visitSingularStringField(value: closeAddress, fieldNumber: 7)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 8)
		}
		if commitmentType != .unknownCommitmentType {
			try visitor.visitSingularEnumField(value: commitmentType, fieldNumber: 9)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_BatchOpenChannelResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &pendingChannels)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !pendingChannels.isEmpty {
			try visitor.visitRepeatedMessageField(value: pendingChannels, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_OpenChannelRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		...
		var _nodePubkey: Data = .init()
		var _nodePubkeyString: String = .init()
		...
		var _closeAddress: String = .init()
		var _fundingShim: Lnrpc_FundingShim?
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		...
		try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
			while let fieldNumber = try decoder.nextFieldNumber() {
				...
				// enabled. https://github.com/apple/swift-protobuf/issues/1034
				switch fieldNumber {
				case 1: try decoder.decodeSingularUInt64Field(value: &_storage._satPerVbyte)
				...
				case 15: try decoder.decodeSingularUInt64Field(value: &_storage._remoteMaxValueInFlightMsat)
				case 16: try decoder.decodeSingularUInt32Field(value: &_storage._remoteMaxHtlcs)
				case 17: try decoder.decodeSingularUInt32Field(value: &_storage._maxLocalCsv)
				case 18: try decoder.decodeSingularEnumField(value: &_storage._commitmentType)
				default: break
				}
			}
		}
...
extension Lnrpc_OpenStatusUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.update {
						hadOneofValue = true
						if case let .chanPending(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 3: try {
					...
					if let current = self.update {
						hadOneofValue = true
						if case let .chanOpen(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 4: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 5: try {
					var v: Lnrpc_ReadyForPsbtFunding?
					var hadOneofValue = false
					if let current = self.update {
						hadOneofValue = true
						if case let .psbtFund(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .chanPending?: try {
				guard case let .chanPending(v)? = self.update else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .chanOpen?: try {
				guard case let .chanOpen(v)? = self.update else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
			}()
		default: break
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 4)
		}
		try { if case let .psbtFund(v)? = self.update {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
		} }()
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChanPointShim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &amt)
			case 2: try decoder.decodeSingularMessageField(value: &_chanPoint)
			case 3: try decoder.decodeSingularMessageField(value: &_localKey)
			case 4: try decoder.decodeSingularBytesField(value: &remoteKey)
			case 5: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 6: try decoder.decodeSingularUInt32Field(value: &thawHeight)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if amt != 0 {
			try visitor.visitSingularInt64Field(value: amt, fieldNumber: 1)
		}
		...
		if !remoteKey.isEmpty {
			try visitor.visitSingularBytesField(value: remoteKey, fieldNumber: 4)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 5)
		}
		if thawHeight != 0 {
			try visitor.visitSingularUInt32Field(value: thawHeight, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PsbtShim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 2: try decoder.decodeSingularBytesField(value: &basePsbt)
			case 3: try decoder.decodeSingularBoolField(value: &noPublish)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 1)
		}
		if !basePsbt.isEmpty {
			try visitor.visitSingularBytesField(value: basePsbt, fieldNumber: 2)
		}
		if noPublish != false {
			try visitor.visitSingularBoolField(value: noPublish, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FundingShim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.shim {
						hadOneofValue = true
						if case let .chanPointShim(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 2: try {
					...
					if let current = self.shim {
						hadOneofValue = true
						if case let .psbtShim(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .chanPointShim?: try {
				guard case let .chanPointShim(v)? = self.shim else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .psbtShim?: try {
				guard case let .psbtShim(v)? = self.shim else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case nil: break
		}
...
extension Lnrpc_FundingPsbtVerify: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &fundedPsbt)
			case 2: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 3: try decoder.decodeSingularBoolField(value: &skipFinalize)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !fundedPsbt.isEmpty {
			try visitor.visitSingularBytesField(value: fundedPsbt, fieldNumber: 1)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 2)
		}
		if skipFinalize != false {
			try visitor.visitSingularBoolField(value: skipFinalize, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FundingPsbtFinalize: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &signedPsbt)
			case 2: try decoder.decodeSingularBytesField(value: &pendingChanID)
			case 3: try decoder.decodeSingularBytesField(value: &finalRawTx)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !signedPsbt.isEmpty {
			try visitor.visitSingularBytesField(value: signedPsbt, fieldNumber: 1)
		}
		if !pendingChanID.isEmpty {
			try visitor.visitSingularBytesField(value: pendingChanID, fieldNumber: 2)
		}
		if !finalRawTx.isEmpty {
			try visitor.visitSingularBytesField(value: finalRawTx, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FundingTransitionMsg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.trigger {
						hadOneofValue = true
						if case let .shimRegister(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 2: try {
					...
					if let current = self.trigger {
						hadOneofValue = true
						if case let .shimCancel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 3: try {
					...
					if let current = self.trigger {
						hadOneofValue = true
						if case let .psbtVerify(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 4: try {
					...
					if let current = self.trigger {
						hadOneofValue = true
						if case let .psbtFinalize(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .shimRegister?: try {
				guard case let .shimRegister(v)? = self.trigger else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .shimCancel?: try {
				guard case let .shimCancel(v)? = self.trigger else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case .psbtVerify?: try {
				guard case let .psbtVerify(v)? = self.trigger else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
			}()
		case .psbtFinalize?: try {
				guard case let .psbtFinalize(v)? = self.trigger else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
			}()
		case nil: break
		}
...
extension Lnrpc_PendingHTLC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try decoder.decodeSingularBoolField(value: &incoming)
			case 2: try decoder.decodeSingularInt64Field(value: &amount)
			case 3: try decoder.decodeSingularStringField(value: &outpoint)
			case 4: try decoder.decodeSingularUInt32Field(value: &maturityHeight)
			case 5: try decoder.decodeSingularInt32Field(value: &blocksTilMaturity)
			case 6: try decoder.decodeSingularUInt32Field(value: &stage)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !outpoint.isEmpty {
			try visitor.visitSingularStringField(value: outpoint, fieldNumber: 3)
		}
		if maturityHeight != 0 {
			try visitor.visitSingularUInt32Field(value: maturityHeight, fieldNumber: 4)
		}
		if blocksTilMaturity != 0 {
			try visitor.visitSingularInt32Field(value: blocksTilMaturity, fieldNumber: 5)
		}
		if stage != 0 {
			try visitor.visitSingularUInt32Field(value: stage, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PendingChannelsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &totalLimboBalance)
			case 2: try decoder.decodeRepeatedMessageField(value: &pendingOpenChannels)
			case 3: try decoder.decodeRepeatedMessageField(value: &pendingClosingChannels)
			case 4: try decoder.decodeRepeatedMessageField(value: &pendingForceClosingChannels)
			case 5: try decoder.decodeRepeatedMessageField(value: &waitingCloseChannels)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if totalLimboBalance != 0 {
			try visitor.visitSingularInt64Field(value: totalLimboBalance, fieldNumber: 1)
		}
		if !pendingOpenChannels.isEmpty {
			try visitor.visitRepeatedMessageField(value: pendingOpenChannels, fieldNumber: 2)
		}
		if !pendingClosingChannels.isEmpty {
			try visitor.visitRepeatedMessageField(value: pendingClosingChannels, fieldNumber: 3)
		}
		if !pendingForceClosingChannels.isEmpty {
			try visitor.visitRepeatedMessageField(value: pendingForceClosingChannels, fieldNumber: 4)
		}
		if !waitingCloseChannels.isEmpty {
			try visitor.visitRepeatedMessageField(value: waitingCloseChannels, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PendingChannelsResponse.PendingChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &remoteNodePub)
			case 2: try decoder.decodeSingularStringField(value: &channelPoint)
			case 3: try decoder.decodeSingularInt64Field(value: &capacity)
			case 4: try decoder.decodeSingularInt64Field(value: &localBalance)
			case 5: try decoder.decodeSingularInt64Field(value: &remoteBalance)
			case 6: try decoder.decodeSingularInt64Field(value: &localChanReserveSat)
			case 7: try decoder.decodeSingularInt64Field(value: &remoteChanReserveSat)
			case 8: try decoder.decodeSingularEnumField(value: &initiator)
			case 9: try decoder.decodeSingularEnumField(value: &commitmentType)
			case 10: try decoder.decodeSingularInt64Field(value: &numForwardingPackages)
			case 11: try decoder.decodeSingularStringField(value: &chanStatusFlags)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !remoteNodePub.isEmpty {
			try visitor.visitSingularStringField(value: remoteNodePub, fieldNumber: 1)
		}
		if !channelPoint.isEmpty {
			try visitor.visitSingularStringField(value: channelPoint, fieldNumber: 2)
		}
		if capacity != 0 {
			try visitor.visitSingularInt64Field(value: capacity, fieldNumber: 3)
		}
		if localBalance != 0 {
			try visitor.visitSingularInt64Field(value: localBalance, fieldNumber: 4)
		}
		if remoteBalance != 0 {
			try visitor.visitSingularInt64Field(value: remoteBalance, fieldNumber: 5)
		}
		if localChanReserveSat != 0 {
			try visitor.visitSingularInt64Field(value: localChanReserveSat, fieldNumber: 6)
		}
		if remoteChanReserveSat != 0 {
			try visitor.visitSingularInt64Field(value: remoteChanReserveSat, fieldNumber: 7)
		}
		if initiator != .unknown {
			try visitor.visitSingularEnumField(value: initiator, fieldNumber: 8)
		}
		if commitmentType != .unknownCommitmentType {
			try visitor.visitSingularEnumField(value: commitmentType, fieldNumber: 9)
		}
		if numForwardingPackages != 0 {
			try visitor.visitSingularInt64Field(value: numForwardingPackages, fieldNumber: 10)
		}
		if !chanStatusFlags.isEmpty {
			try visitor.visitSingularStringField(value: chanStatusFlags, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PendingChannelsResponse.PendingOpenChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_channel)
			case 2: try decoder.decodeSingularUInt32Field(value: &confirmationHeight)
			case 4: try decoder.decodeSingularInt64Field(value: &commitFee)
			case 5: try decoder.decodeSingularInt64Field(value: &commitWeight)
			case 6: try decoder.decodeSingularInt64Field(value: &feePerKw)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if confirmationHeight != 0 {
			try visitor.visitSingularUInt32Field(value: confirmationHeight, fieldNumber: 2)
		}
		if commitFee != 0 {
			try visitor.visitSingularInt64Field(value: commitFee, fieldNumber: 4)
		}
		if commitWeight != 0 {
			try visitor.visitSingularInt64Field(value: commitWeight, fieldNumber: 5)
		}
		if feePerKw != 0 {
			try visitor.visitSingularInt64Field(value: feePerKw, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PendingChannelsResponse.WaitingCloseChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		...
		var _commitments: Lnrpc_PendingChannelsResponse.Commitments?
		var _closingTxid: String = .init()
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		...
		try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
			while let fieldNumber = try decoder.nextFieldNumber() {
				...
				case 3: try decoder.decodeSingularMessageField(value: &_storage._commitments)
				case 4: try decoder.decodeSingularStringField(value: &_storage._closingTxid)
				default: break
				}
			}
		}
...
extension Lnrpc_PendingChannelsResponse.Commitments: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &localTxid)
			case 2: try decoder.decodeSingularStringField(value: &remoteTxid)
			case 3: try decoder.decodeSingularStringField(value: &remotePendingTxid)
			case 4: try decoder.decodeSingularUInt64Field(value: &localCommitFeeSat)
			case 5: try decoder.decodeSingularUInt64Field(value: &remoteCommitFeeSat)
			case 6: try decoder.decodeSingularUInt64Field(value: &remotePendingCommitFeeSat)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !localTxid.isEmpty {
			try visitor.visitSingularStringField(value: localTxid, fieldNumber: 1)
		}
		if !remoteTxid.isEmpty {
			try visitor.visitSingularStringField(value: remoteTxid, fieldNumber: 2)
		}
		if !remotePendingTxid.isEmpty {
			try visitor.visitSingularStringField(value: remotePendingTxid, fieldNumber: 3)
		}
		if localCommitFeeSat != 0 {
			try visitor.visitSingularUInt64Field(value: localCommitFeeSat, fieldNumber: 4)
		}
		if remoteCommitFeeSat != 0 {
			try visitor.visitSingularUInt64Field(value: remoteCommitFeeSat, fieldNumber: 5)
		}
		if remotePendingCommitFeeSat != 0 {
			try visitor.visitSingularUInt64Field(value: remotePendingCommitFeeSat, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PendingChannelsResponse.ClosedChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_channel)
			case 2: try decoder.decodeSingularStringField(value: &closingTxid)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !closingTxid.isEmpty {
			try visitor.visitSingularStringField(value: closingTxid, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		...
		try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
			while let fieldNumber = try decoder.nextFieldNumber() {
				...
				case 9: try decoder.decodeSingularEnumField(value: &_storage._anchor)
				default: break
				}
			}
		}
...
extension Lnrpc_ChannelEventUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.channel {
						hadOneofValue = true
						if case let .openChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 2: try {
					...
					if let current = self.channel {
						hadOneofValue = true
						if case let .closedChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 3: try {
					...
					if let current = self.channel {
						hadOneofValue = true
						if case let .activeChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 4: try {
					...
					if let current = self.channel {
						hadOneofValue = true
						if case let .inactiveChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 5: try decoder.decodeSingularEnumField(value: &type)
			case 6: try {
					var v: Lnrpc_PendingUpdate?
					var hadOneofValue = false
					if let current = self.channel {
						hadOneofValue = true
						if case let .pendingOpenChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 7: try {
					...
					if let current = self.channel {
						hadOneofValue = true
						if case let .fullyResolvedChannel(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .openChannel?: try {
				guard case let .openChannel(v)? = self.channel else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .closedChannel?: try {
				guard case let .closedChannel(v)? = self.channel else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case .activeChannel?: try {
				guard case let .activeChannel(v)? = self.channel else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
			}()
		case .inactiveChannel?: try {
				guard case let .inactiveChannel(v)? = self.channel else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
			}()
		default: break
		}
		if type != .openChannel {
			try visitor.visitSingularEnumField(value: type, fieldNumber: 5)
		}
		switch channel {
		case .pendingOpenChannel?: try {
				guard case let .pendingOpenChannel(v)? = self.channel else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
			}()
		case .fullyResolvedChannel?: try {
				guard case let .fullyResolvedChannel(v)? = self.channel else { preconditionFailure() }
...
extension Lnrpc_WalletAccountBalance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &confirmedBalance)
			case 2: try decoder.decodeSingularInt64Field(value: &unconfirmedBalance)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if confirmedBalance != 0 {
			try visitor.visitSingularInt64Field(value: confirmedBalance, fieldNumber: 1)
		}
		if unconfirmedBalance != 0 {
			try visitor.visitSingularInt64Field(value: unconfirmedBalance, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_WalletBalanceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularInt64Field(value: &totalBalance)
			case 2: try decoder.decodeSingularInt64Field(value: &confirmedBalance)
			case 3: try decoder.decodeSingularInt64Field(value: &unconfirmedBalance)
			case 4: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_WalletAccountBalance>.self, value: &accountBalance)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if totalBalance != 0 {
			try visitor.visitSingularInt64Field(value: totalBalance, fieldNumber: 1)
		}
		if confirmedBalance != 0 {
			try visitor.visitSingularInt64Field(value: confirmedBalance, fieldNumber: 2)
		}
		if unconfirmedBalance != 0 {
			try visitor.visitSingularInt64Field(value: unconfirmedBalance, fieldNumber: 3)
		}
		if !accountBalance.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_WalletAccountBalance>.self, value: accountBalance, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Amount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &sat)
			case 2: try decoder.decodeSingularUInt64Field(value: &msat)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if sat != 0 {
			try visitor.visitSingularUInt64Field(value: sat, fieldNumber: 1)
		}
		if msat != 0 {
			try visitor.visitSingularUInt64Field(value: msat, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelBalanceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularInt64Field(value: &pendingOpenBalance)
			case 3: try decoder.decodeSingularMessageField(value: &_localBalance)
			case 4: try decoder.decodeSingularMessageField(value: &_remoteBalance)
			case 5: try decoder.decodeSingularMessageField(value: &_unsettledLocalBalance)
			case 6: try decoder.decodeSingularMessageField(value: &_unsettledRemoteBalance)
			case 7: try decoder.decodeSingularMessageField(value: &_pendingOpenLocalBalance)
			case 8: try decoder.decodeSingularMessageField(value: &_pendingOpenRemoteBalance)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if pendingOpenBalance != 0 {
			try visitor.visitSingularInt64Field(value: pendingOpenBalance, fieldNumber: 2)
		}
...
extension Lnrpc_QueryRoutesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &pubKey)
			case 2: try decoder.decodeSingularInt64Field(value: &amt)
			case 4: try decoder.decodeSingularInt32Field(value: &finalCltvDelta)
			case 5: try decoder.decodeSingularMessageField(value: &_feeLimit)
			case 6: try decoder.decodeRepeatedBytesField(value: &ignoredNodes)
			case 7: try decoder.decodeRepeatedMessageField(value: &ignoredEdges)
			case 8: try decoder.decodeSingularStringField(value: &sourcePubKey)
			case 9: try decoder.decodeSingularBoolField(value: &useMissionControl)
			case 10: try decoder.decodeRepeatedMessageField(value: &ignoredPairs)
			case 11: try decoder.decodeSingularUInt32Field(value: &cltvLimit)
			case 12: try decoder.decodeSingularInt64Field(value: &amtMsat)
			case 13: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: &destCustomRecords)
			case 14: try decoder.decodeSingularUInt64Field(value: &outgoingChanID)
			case 15: try decoder.decodeSingularBytesField(value: &lastHopPubkey)
			case 16: try decoder.decodeRepeatedMessageField(value: &routeHints)
			case 17: try decoder.decodeRepeatedEnumField(value: &destFeatures)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if amt != 0 {
			try visitor.visitSingularInt64Field(value: amt, fieldNumber: 2)
		}
		if finalCltvDelta != 0 {
			try visitor.visitSingularInt32Field(value: finalCltvDelta, fieldNumber: 4)
		}
		try { if let v = self._feeLimit {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
		} }()
		if !ignoredNodes.isEmpty {
			try visitor.visitRepeatedBytesField(value: ignoredNodes, fieldNumber: 6)
		}
		if !ignoredEdges.isEmpty {
			try visitor.visitRepeatedMessageField(value: ignoredEdges, fieldNumber: 7)
		}
		if !sourcePubKey.isEmpty {
			try visitor.visitSingularStringField(value: sourcePubKey, fieldNumber: 8)
		}
		if useMissionControl != false {
			try visitor.visitSingularBoolField(value: useMissionControl, fieldNumber: 9)
		}
		if !ignoredPairs.isEmpty {
			try visitor.visitRepeatedMessageField(value: ignoredPairs, fieldNumber: 10)
		}
		if cltvLimit != 0 {
			try visitor.visitSingularUInt32Field(value: cltvLimit, fieldNumber: 11)
		}
		if amtMsat != 0 {
			try visitor.visitSingularInt64Field(value: amtMsat, fieldNumber: 12)
		}
		if !destCustomRecords.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: destCustomRecords, fieldNumber: 13)
		}
		if outgoingChanID != 0 {
			try visitor.visitSingularUInt64Field(value: outgoingChanID, fieldNumber: 14)
		}
		if !lastHopPubkey.isEmpty {
			try visitor.visitSingularBytesField(value: lastHopPubkey, fieldNumber: 15)
		}
		if !routeHints.isEmpty {
			try visitor.visitRepeatedMessageField(value: routeHints, fieldNumber: 16)
		}
		if !destFeatures.isEmpty {
			try visitor.visitPackedEnumField(value: destFeatures, fieldNumber: 17)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_EdgeLocator: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &channelID)
			case 2: try decoder.decodeSingularBoolField(value: &directionReverse)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if channelID != 0 {
			try visitor.visitSingularUInt64Field(value: channelID, fieldNumber: 1)
		}
		if directionReverse != false {
			try visitor.visitSingularBoolField(value: directionReverse, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_QueryRoutesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &routes)
			case 2: try decoder.decodeSingularDoubleField(value: &successProb)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !routes.isEmpty {
			try visitor.visitRepeatedMessageField(value: routes, fieldNumber: 1)
		}
		if successProb != 0 {
			try visitor.visitSingularDoubleField(value: successProb, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Hop: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 2: try decoder.decodeSingularInt64Field(value: &chanCapacity)
			case 3: try decoder.decodeSingularInt64Field(value: &amtToForward)
			case 4: try decoder.decodeSingularInt64Field(value: &fee)
			case 5: try decoder.decodeSingularUInt32Field(value: &expiry)
			case 6: try decoder.decodeSingularInt64Field(value: &amtToForwardMsat)
			case 7: try decoder.decodeSingularInt64Field(value: &feeMsat)
			case 8: try decoder.decodeSingularStringField(value: &pubKey)
			case 9: try decoder.decodeSingularBoolField(value: &tlvPayload)
			case 10: try decoder.decodeSingularMessageField(value: &_mppRecord)
			case 11: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: &customRecords)
			case 12: try decoder.decodeSingularMessageField(value: &_ampRecord)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if chanID != 0 {
			try visitor.visitSingularUInt64Field(value: chanID, fieldNumber: 1)
		}
		if chanCapacity != 0 {
			try visitor.visitSingularInt64Field(value: chanCapacity, fieldNumber: 2)
		}
		if amtToForward != 0 {
			try visitor.visitSingularInt64Field(value: amtToForward, fieldNumber: 3)
		}
		if fee != 0 {
			try visitor.visitSingularInt64Field(value: fee, fieldNumber: 4)
		}
		if expiry != 0 {
			try visitor.visitSingularUInt32Field(value: expiry, fieldNumber: 5)
		}
		if amtToForwardMsat != 0 {
			try visitor.visitSingularInt64Field(value: amtToForwardMsat, fieldNumber: 6)
		}
		if feeMsat != 0 {
			try visitor.visitSingularInt64Field(value: feeMsat, fieldNumber: 7)
		}
		if !pubKey.isEmpty {
			try visitor.visitSingularStringField(value: pubKey, fieldNumber: 8)
		}
		if tlvPayload != false {
			try visitor.visitSingularBoolField(value: tlvPayload, fieldNumber: 9)
		}
		try { if let v = self._mppRecord {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
		} }()
		if !customRecords.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: customRecords, fieldNumber: 11)
		}
...
extension Lnrpc_MPPRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 10: try decoder.decodeSingularInt64Field(value: &totalAmtMsat)
			case 11: try decoder.decodeSingularBytesField(value: &paymentAddr)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if totalAmtMsat != 0 {
			try visitor.visitSingularInt64Field(value: totalAmtMsat, fieldNumber: 10)
		}
		if !paymentAddr.isEmpty {
			try visitor.visitSingularBytesField(value: paymentAddr, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_AMPRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &rootShare)
			case 2: try decoder.decodeSingularBytesField(value: &setID)
			case 3: try decoder.decodeSingularUInt32Field(value: &childIndex)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !rootShare.isEmpty {
			try visitor.visitSingularBytesField(value: rootShare, fieldNumber: 1)
		}
		if !setID.isEmpty {
			try visitor.visitSingularBytesField(value: setID, fieldNumber: 2)
		}
		if childIndex != 0 {
			try visitor.visitSingularUInt32Field(value: childIndex, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &totalTimeLock)
			case 2: try decoder.decodeSingularInt64Field(value: &totalFees)
			case 3: try decoder.decodeSingularInt64Field(value: &totalAmt)
			case 4: try decoder.decodeRepeatedMessageField(value: &hops)
			case 5: try decoder.decodeSingularInt64Field(value: &totalFeesMsat)
			case 6: try decoder.decodeSingularInt64Field(value: &totalAmtMsat)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if totalTimeLock != 0 {
			try visitor.visitSingularUInt32Field(value: totalTimeLock, fieldNumber: 1)
		}
		if totalFees != 0 {
			try visitor.visitSingularInt64Field(value: totalFees, fieldNumber: 2)
		}
		if totalAmt != 0 {
			try visitor.visitSingularInt64Field(value: totalAmt, fieldNumber: 3)
		}
		if !hops.isEmpty {
			try visitor.visitRepeatedMessageField(value: hops, fieldNumber: 4)
		}
		if totalFeesMsat != 0 {
			try visitor.visitSingularInt64Field(value: totalFeesMsat, fieldNumber: 5)
		}
		if totalAmtMsat != 0 {
			try visitor.visitSingularInt64Field(value: totalAmtMsat, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NodeInfoRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &pubKey)
			case 2: try decoder.decodeSingularBoolField(value: &includeChannels)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if includeChannels != false {
			try visitor.visitSingularBoolField(value: includeChannels, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NodeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_node)
			case 2: try decoder.decodeSingularUInt32Field(value: &numChannels)
			case 3: try decoder.decodeSingularInt64Field(value: &totalCapacity)
			case 4: try decoder.decodeRepeatedMessageField(value: &channels)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if numChannels != 0 {
			try visitor.visitSingularUInt32Field(value: numChannels, fieldNumber: 2)
		}
		if totalCapacity != 0 {
			try visitor.visitSingularInt64Field(value: totalCapacity, fieldNumber: 3)
		}
		if !channels.isEmpty {
			try visitor.visitRepeatedMessageField(value: channels, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_LightningNode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &lastUpdate)
			case 2: try decoder.decodeSingularStringField(value: &pubKey)
			case 3: try decoder.decodeSingularStringField(value: &alias)
			case 4: try decoder.decodeRepeatedMessageField(value: &addresses)
			case 5: try decoder.decodeSingularStringField(value: &color)
			case 6: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: &features)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if lastUpdate != 0 {
			try visitor.visitSingularUInt32Field(value: lastUpdate, fieldNumber: 1)
		}
		if !pubKey.isEmpty {
			try visitor.visitSingularStringField(value: pubKey, fieldNumber: 2)
		}
		if !alias.isEmpty {
			try visitor.visitSingularStringField(value: alias, fieldNumber: 3)
		}
		if !addresses.isEmpty {
			try visitor.visitRepeatedMessageField(value: addresses, fieldNumber: 4)
		}
		if !color.isEmpty {
			try visitor.visitSingularStringField(value: color, fieldNumber: 5)
		}
		if !features.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: features, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NodeAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &addr)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !addr.isEmpty {
			try visitor.visitSingularStringField(value: addr, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RoutingPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &timeLockDelta)
			case 2: try decoder.decodeSingularInt64Field(value: &minHtlc)
			case 3: try decoder.decodeSingularInt64Field(value: &feeBaseMsat)
			case 4: try decoder.decodeSingularInt64Field(value: &feeRateMilliMsat)
			case 5: try decoder.decodeSingularBoolField(value: &disabled)
			case 6: try decoder.decodeSingularUInt64Field(value: &maxHtlcMsat)
			case 7: try decoder.decodeSingularUInt32Field(value: &lastUpdate)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if timeLockDelta != 0 {
			try visitor.visitSingularUInt32Field(value: timeLockDelta, fieldNumber: 1)
		}
		if minHtlc != 0 {
			try visitor.visitSingularInt64Field(value: minHtlc, fieldNumber: 2)
		}
		if feeBaseMsat != 0 {
			try visitor.visitSingularInt64Field(value: feeBaseMsat, fieldNumber: 3)
		}
		if feeRateMilliMsat != 0 {
			try visitor.visitSingularInt64Field(value: feeRateMilliMsat, fieldNumber: 4)
		}
		if disabled != false {
			try visitor.visitSingularBoolField(value: disabled, fieldNumber: 5)
		}
		if maxHtlcMsat != 0 {
			try visitor.visitSingularUInt64Field(value: maxHtlcMsat, fieldNumber: 6)
		}
		if lastUpdate != 0 {
			try visitor.visitSingularUInt32Field(value: lastUpdate, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelEdge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		...
		var _chanPoint: String = .init()
		var _lastUpdate: UInt32 = 0
		var _node1Pub: String = .init()
		var _node2Pub: String = .init()
		var _capacity: Int64 = 0
...
extension Lnrpc_ChannelGraphRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &includeUnannounced)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if includeUnannounced != false {
			try visitor.visitSingularBoolField(value: includeUnannounced, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelGraph: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeRepeatedMessageField(value: &edges)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !edges.isEmpty {
			try visitor.visitRepeatedMessageField(value: edges, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NodeMetricsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_FloatMetric>.self, value: &betweennessCentrality)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !betweennessCentrality.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_FloatMetric>.self, value: betweennessCentrality, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FloatMetric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularDoubleField(value: &normalizedValue)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if normalizedValue != 0 {
			try visitor.visitSingularDoubleField(value: normalizedValue, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NetworkInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &graphDiameter)
			case 2: try decoder.decodeSingularDoubleField(value: &avgOutDegree)
			case 3: try decoder.decodeSingularUInt32Field(value: &maxOutDegree)
			case 4: try decoder.decodeSingularUInt32Field(value: &numNodes)
			case 5: try decoder.decodeSingularUInt32Field(value: &numChannels)
			case 6: try decoder.decodeSingularInt64Field(value: &totalNetworkCapacity)
			case 7: try decoder.decodeSingularDoubleField(value: &avgChannelSize)
			case 8: try decoder.decodeSingularInt64Field(value: &minChannelSize)
			case 9: try decoder.decodeSingularInt64Field(value: &maxChannelSize)
			case 10: try decoder.decodeSingularInt64Field(value: &medianChannelSizeSat)
			case 11: try decoder.decodeSingularUInt64Field(value: &numZombieChans)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if graphDiameter != 0 {
			try visitor.visitSingularUInt32Field(value: graphDiameter, fieldNumber: 1)
		}
		if avgOutDegree != 0 {
			try visitor.visitSingularDoubleField(value: avgOutDegree, fieldNumber: 2)
		}
		if maxOutDegree != 0 {
			try visitor.visitSingularUInt32Field(value: maxOutDegree, fieldNumber: 3)
		}
		if numNodes != 0 {
			try visitor.visitSingularUInt32Field(value: numNodes, fieldNumber: 4)
		}
		if numChannels != 0 {
			try visitor.visitSingularUInt32Field(value: numChannels, fieldNumber: 5)
		}
		if totalNetworkCapacity != 0 {
			try visitor.visitSingularInt64Field(value: totalNetworkCapacity, fieldNumber: 6)
		}
		if avgChannelSize != 0 {
			try visitor.visitSingularDoubleField(value: avgChannelSize, fieldNumber: 7)
		}
		if minChannelSize != 0 {
			try visitor.visitSingularInt64Field(value: minChannelSize, fieldNumber: 8)
		}
		if maxChannelSize != 0 {
			try visitor.visitSingularInt64Field(value: maxChannelSize, fieldNumber: 9)
		}
		if medianChannelSizeSat != 0 {
			try visitor.visitSingularInt64Field(value: medianChannelSizeSat, fieldNumber: 10)
		}
		if numZombieChans != 0 {
			try visitor.visitSingularUInt64Field(value: numZombieChans, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_GraphTopologyUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &nodeUpdates)
			case 2: try decoder.decodeRepeatedMessageField(value: &channelUpdates)
			case 3: try decoder.decodeRepeatedMessageField(value: &closedChans)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !nodeUpdates.isEmpty {
			try visitor.visitRepeatedMessageField(value: nodeUpdates, fieldNumber: 1)
		}
		if !channelUpdates.isEmpty {
			try visitor.visitRepeatedMessageField(value: channelUpdates, fieldNumber: 2)
		}
		if !closedChans.isEmpty {
			try visitor.visitRepeatedMessageField(value: closedChans, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_NodeUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularStringField(value: &identityKey)
			case 3: try decoder.decodeSingularBytesField(value: &globalFeatures)
			case 4: try decoder.decodeSingularStringField(value: &alias)
			case 5: try decoder.decodeSingularStringField(value: &color)
			case 6: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: &features)
			case 7: try decoder.decodeRepeatedMessageField(value: &nodeAddresses)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !identityKey.isEmpty {
			try visitor.visitSingularStringField(value: identityKey, fieldNumber: 2)
		}
		if !globalFeatures.isEmpty {
			try visitor.visitSingularBytesField(value: globalFeatures, fieldNumber: 3)
		}
		if !alias.isEmpty {
			try visitor.visitSingularStringField(value: alias, fieldNumber: 4)
		}
		if !color.isEmpty {
			try visitor.visitSingularStringField(value: color, fieldNumber: 5)
		}
		...
		if !nodeAddresses.isEmpty {
			try visitor.visitRepeatedMessageField(value: nodeAddresses, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelEdgeUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularMessageField(value: &_chanPoint)
			case 3: try decoder.decodeSingularInt64Field(value: &capacity)
			case 4: try decoder.decodeSingularMessageField(value: &_routingPolicy)
			case 5: try decoder.decodeSingularStringField(value: &advertisingNode)
			case 6: try decoder.decodeSingularStringField(value: &connectingNode)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !advertisingNode.isEmpty {
			try visitor.visitSingularStringField(value: advertisingNode, fieldNumber: 5)
		}
		if !connectingNode.isEmpty {
			try visitor.visitSingularStringField(value: connectingNode, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ClosedChannelUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 2: try decoder.decodeSingularInt64Field(value: &capacity)
			case 3: try decoder.decodeSingularUInt32Field(value: &closedHeight)
			case 4: try decoder.decodeSingularMessageField(value: &_chanPoint)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if capacity != 0 {
			try visitor.visitSingularInt64Field(value: capacity, fieldNumber: 2)
		}
		if closedHeight != 0 {
			try visitor.visitSingularUInt32Field(value: closedHeight, fieldNumber: 3)
		}
		try { if let v = self._chanPoint {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
		} }()
...
extension Lnrpc_HopHint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &nodeID)
			case 2: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 3: try decoder.decodeSingularUInt32Field(value: &feeBaseMsat)
			case 4: try decoder.decodeSingularUInt32Field(value: &feeProportionalMillionths)
			case 5: try decoder.decodeSingularUInt32Field(value: &cltvExpiryDelta)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !nodeID.isEmpty {
			try visitor.visitSingularStringField(value: nodeID, fieldNumber: 1)
		}
		if chanID != 0 {
			try visitor.visitSingularUInt64Field(value: chanID, fieldNumber: 2)
		}
		if feeBaseMsat != 0 {
			try visitor.visitSingularUInt32Field(value: feeBaseMsat, fieldNumber: 3)
		}
		if feeProportionalMillionths != 0 {
			try visitor.visitSingularUInt32Field(value: feeProportionalMillionths, fieldNumber: 4)
		}
		if cltvExpiryDelta != 0 {
			try visitor.visitSingularUInt32Field(value: cltvExpiryDelta, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_SetID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &setID)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !setID.isEmpty {
			try visitor.visitSingularBytesField(value: setID, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RouteHint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &hopHints)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !hopHints.isEmpty {
			try visitor.visitRepeatedMessageField(value: hopHints, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_AMPInvoiceState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularUInt64Field(value: &settleIndex)
			case 3: try decoder.decodeSingularInt64Field(value: &settleTime)
			case 5: try decoder.decodeSingularInt64Field(value: &amtPaidMsat)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if settleIndex != 0 {
			try visitor.visitSingularUInt64Field(value: settleIndex, fieldNumber: 2)
		}
		if settleTime != 0 {
			try visitor.visitSingularInt64Field(value: settleTime, fieldNumber: 3)
		}
		if amtPaidMsat != 0 {
			try visitor.visitSingularInt64Field(value: amtPaidMsat, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Invoice: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		var _memo: String = .init()
		var _rPreimage: Data = .init()
		var _rHash: Data = .init()
		var _value: Int64 = 0
		var _valueMsat: Int64 = 0
		var _settled: Bool = false
		var _creationDate: Int64 = 0
		var _settleDate: Int64 = 0
		var _paymentRequest: String = .init()
		var _descriptionHash: Data = .init()
		var _expiry: Int64 = 0
		var _fallbackAddr: String = .init()
		...
		var _paymentAddr: Data = .init()
		var _isAmp: Bool = false
		var _ampInvoiceState: [String: Lnrpc_AMPInvoiceState] = [:]
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		...
		try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
			while let fieldNumber = try decoder.nextFieldNumber() {
				...
				case 27: try decoder.decodeSingularBoolField(value: &_storage._isAmp)
				case 28: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_AMPInvoiceState>.self, value: &_storage._ampInvoiceState)
				default: break
				}
			}
		}
...
extension Lnrpc_InvoiceHTLC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 2: try decoder.decodeSingularUInt64Field(value: &htlcIndex)
			case 3: try decoder.decodeSingularUInt64Field(value: &amtMsat)
			case 4: try decoder.decodeSingularInt32Field(value: &acceptHeight)
			case 5: try decoder.decodeSingularInt64Field(value: &acceptTime)
			case 6: try decoder.decodeSingularInt64Field(value: &resolveTime)
			case 7: try decoder.decodeSingularInt32Field(value: &expiryHeight)
			case 8: try decoder.decodeSingularEnumField(value: &state)
			case 9: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: &customRecords)
			case 10: try decoder.decodeSingularUInt64Field(value: &mppTotalAmtMsat)
			case 11: try decoder.decodeSingularMessageField(value: &_amp)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if htlcIndex != 0 {
			try visitor.visitSingularUInt64Field(value: htlcIndex, fieldNumber: 2)
		}
		if amtMsat != 0 {
			try visitor.visitSingularUInt64Field(value: amtMsat, fieldNumber: 3)
		}
		if acceptHeight != 0 {
			try visitor.visitSingularInt32Field(value: acceptHeight, fieldNumber: 4)
		}
		if acceptTime != 0 {
			try visitor.visitSingularInt64Field(value: acceptTime, fieldNumber: 5)
		}
		if resolveTime != 0 {
			try visitor.visitSingularInt64Field(value: resolveTime, fieldNumber: 6)
		}
		if expiryHeight != 0 {
			try visitor.visitSingularInt32Field(value: expiryHeight, fieldNumber: 7)
		}
		if state != .accepted {
			try visitor.visitSingularEnumField(value: state, fieldNumber: 8)
		}
		if !customRecords.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufUInt64, SwiftProtobuf.ProtobufBytes>.self, value: customRecords, fieldNumber: 9)
		}
		if mppTotalAmtMsat != 0 {
			try visitor.visitSingularUInt64Field(value: mppTotalAmtMsat, fieldNumber: 10)
		}
...
extension Lnrpc_AMP: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularBytesField(value: &setID)
			case 3: try decoder.decodeSingularUInt32Field(value: &childIndex)
			case 4: try decoder.decodeSingularBytesField(value: &hash)
			case 5: try decoder.decodeSingularBytesField(value: &preimage)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !hash.isEmpty {
			try visitor.visitSingularBytesField(value: hash, fieldNumber: 4)
		}
		if !preimage.isEmpty {
			try visitor.visitSingularBytesField(value: preimage, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_AddInvoiceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &rHash)
			case 2: try decoder.decodeSingularStringField(value: &paymentRequest)
			case 16: try decoder.decodeSingularUInt64Field(value: &addIndex)
			case 17: try decoder.decodeSingularBytesField(value: &paymentAddr)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !rHash.isEmpty {
			try visitor.visitSingularBytesField(value: rHash, fieldNumber: 1)
		}
		if !paymentRequest.isEmpty {
			try visitor.visitSingularStringField(value: paymentRequest, fieldNumber: 2)
		}
		if addIndex != 0 {
			try visitor.visitSingularUInt64Field(value: addIndex, fieldNumber: 16)
		}
		if !paymentAddr.isEmpty {
			try visitor.visitSingularBytesField(value: paymentAddr, fieldNumber: 17)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PaymentHash: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &rHashStr)
			case 2: try decoder.decodeSingularBytesField(value: &rHash)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !rHashStr.isEmpty {
			try visitor.visitSingularStringField(value: rHashStr, fieldNumber: 1)
		}
		if !rHash.isEmpty {
			try visitor.visitSingularBytesField(value: rHash, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListInvoiceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &pendingOnly)
			case 4: try decoder.decodeSingularUInt64Field(value: &indexOffset)
			case 5: try decoder.decodeSingularUInt64Field(value: &numMaxInvoices)
			case 6: try decoder.decodeSingularBoolField(value: &reversed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if pendingOnly != false {
			try visitor.visitSingularBoolField(value: pendingOnly, fieldNumber: 1)
		}
		if indexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: indexOffset, fieldNumber: 4)
		}
		if numMaxInvoices != 0 {
			try visitor.visitSingularUInt64Field(value: numMaxInvoices, fieldNumber: 5)
		}
		if reversed != false {
			try visitor.visitSingularBoolField(value: reversed, fieldNumber: 6)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListInvoiceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &invoices)
			case 2: try decoder.decodeSingularUInt64Field(value: &lastIndexOffset)
			case 3: try decoder.decodeSingularUInt64Field(value: &firstIndexOffset)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !invoices.isEmpty {
			try visitor.visitRepeatedMessageField(value: invoices, fieldNumber: 1)
		}
		if lastIndexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: lastIndexOffset, fieldNumber: 2)
		}
		if firstIndexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: firstIndexOffset, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_InvoiceSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &addIndex)
			case 2: try decoder.decodeSingularUInt64Field(value: &settleIndex)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if addIndex != 0 {
			try visitor.visitSingularUInt64Field(value: addIndex, fieldNumber: 1)
		}
		if settleIndex != 0 {
			try visitor.visitSingularUInt64Field(value: settleIndex, fieldNumber: 2)
		}
...
extension Lnrpc_Payment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &paymentHash)
			case 2: try decoder.decodeSingularInt64Field(value: &value)
			case 3: try decoder.decodeSingularInt64Field(value: &creationDate)
			case 5: try decoder.decodeSingularInt64Field(value: &fee)
			case 6: try decoder.decodeSingularStringField(value: &paymentPreimage)
			case 7: try decoder.decodeSingularInt64Field(value: &valueSat)
			case 8: try decoder.decodeSingularInt64Field(value: &valueMsat)
			case 9: try decoder.decodeSingularStringField(value: &paymentRequest)
			case 10: try decoder.decodeSingularEnumField(value: &status)
			case 11: try decoder.decodeSingularInt64Field(value: &feeSat)
			case 12: try decoder.decodeSingularInt64Field(value: &feeMsat)
			case 13: try decoder.decodeSingularInt64Field(value: &creationTimeNs)
			case 14: try decoder.decodeRepeatedMessageField(value: &htlcs)
			case 15: try decoder.decodeSingularUInt64Field(value: &paymentIndex)
			case 16: try decoder.decodeSingularEnumField(value: &failureReason)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !paymentHash.isEmpty {
			try visitor.visitSingularStringField(value: paymentHash, fieldNumber: 1)
		}
		if value != 0 {
			try visitor.visitSingularInt64Field(value: value, fieldNumber: 2)
		}
		if creationDate != 0 {
			try visitor.visitSingularInt64Field(value: creationDate, fieldNumber: 3)
		}
		if fee != 0 {
			try visitor.visitSingularInt64Field(value: fee, fieldNumber: 5)
		}
		if !paymentPreimage.isEmpty {
			try visitor.visitSingularStringField(value: paymentPreimage, fieldNumber: 6)
		}
		if valueSat != 0 {
			try visitor.visitSingularInt64Field(value: valueSat, fieldNumber: 7)
		}
		if valueMsat != 0 {
			try visitor.visitSingularInt64Field(value: valueMsat, fieldNumber: 8)
		}
		if !paymentRequest.isEmpty {
			try visitor.visitSingularStringField(value: paymentRequest, fieldNumber: 9)
		}
		if status != .unknown {
			try visitor.visitSingularEnumField(value: status, fieldNumber: 10)
		}
		if feeSat != 0 {
			try visitor.visitSingularInt64Field(value: feeSat, fieldNumber: 11)
		}
		if feeMsat != 0 {
			try visitor.visitSingularInt64Field(value: feeMsat, fieldNumber: 12)
		}
		if creationTimeNs != 0 {
			try visitor.visitSingularInt64Field(value: creationTimeNs, fieldNumber: 13)
		}
		if !htlcs.isEmpty {
			try visitor.visitRepeatedMessageField(value: htlcs, fieldNumber: 14)
		}
		if paymentIndex != 0 {
			try visitor.visitSingularUInt64Field(value: paymentIndex, fieldNumber: 15)
		}
		if failureReason != .failureReasonNone {
			try visitor.visitSingularEnumField(value: failureReason, fieldNumber: 16)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_HTLCAttempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularMessageField(value: &_route)
			case 3: try decoder.decodeSingularInt64Field(value: &attemptTimeNs)
			case 4: try decoder.decodeSingularInt64Field(value: &resolveTimeNs)
			case 5: try decoder.decodeSingularMessageField(value: &_failure)
			case 6: try decoder.decodeSingularBytesField(value: &preimage)
			case 7: try decoder.decodeSingularUInt64Field(value: &attemptID)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if attemptTimeNs != 0 {
			try visitor.visitSingularInt64Field(value: attemptTimeNs, fieldNumber: 3)
		}
		if resolveTimeNs != 0 {
			try visitor.visitSingularInt64Field(value: resolveTimeNs, fieldNumber: 4)
		}
		try { if let v = self._failure {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
		} }()
		if !preimage.isEmpty {
			try visitor.visitSingularBytesField(value: preimage, fieldNumber: 6)
		}
		if attemptID != 0 {
			try visitor.visitSingularUInt64Field(value: attemptID, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListPaymentsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &includeIncomplete)
			case 2: try decoder.decodeSingularUInt64Field(value: &indexOffset)
			case 3: try decoder.decodeSingularUInt64Field(value: &maxPayments)
			case 4: try decoder.decodeSingularBoolField(value: &reversed)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if includeIncomplete != false {
			try visitor.visitSingularBoolField(value: includeIncomplete, fieldNumber: 1)
		}
		if indexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: indexOffset, fieldNumber: 2)
		}
		if maxPayments != 0 {
			try visitor.visitSingularUInt64Field(value: maxPayments, fieldNumber: 3)
		}
		if reversed != false {
			try visitor.visitSingularBoolField(value: reversed, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListPaymentsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &payments)
			case 2: try decoder.decodeSingularUInt64Field(value: &firstIndexOffset)
			case 3: try decoder.decodeSingularUInt64Field(value: &lastIndexOffset)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !payments.isEmpty {
			try visitor.visitRepeatedMessageField(value: payments, fieldNumber: 1)
		}
		if firstIndexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: firstIndexOffset, fieldNumber: 2)
		}
		if lastIndexOffset != 0 {
			try visitor.visitSingularUInt64Field(value: lastIndexOffset, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DeletePaymentRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &paymentHash)
			case 2: try decoder.decodeSingularBoolField(value: &failedHtlcsOnly)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if failedHtlcsOnly != false {
			try visitor.visitSingularBoolField(value: failedHtlcsOnly, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DeleteAllPaymentsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &failedPaymentsOnly)
			case 2: try decoder.decodeSingularBoolField(value: &failedHtlcsOnly)
			default: break
			}
		}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if failedPaymentsOnly != false {
			try visitor.visitSingularBoolField(value: failedPaymentsOnly, fieldNumber: 1)
		}
		if failedHtlcsOnly != false {
			try visitor.visitSingularBoolField(value: failedHtlcsOnly, fieldNumber: 2)
		}
...
extension Lnrpc_AbandonChannelRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_channelPoint)
			case 2: try decoder.decodeSingularBoolField(value: &pendingFundingShimOnly)
			case 3: try decoder.decodeSingularBoolField(value: &iKnowWhatIAmDoing)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if pendingFundingShimOnly != false {
			try visitor.visitSingularBoolField(value: pendingFundingShimOnly, fieldNumber: 2)
		}
		if iKnowWhatIAmDoing != false {
			try visitor.visitSingularBoolField(value: iKnowWhatIAmDoing, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DebugLevelRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &show)
			case 2: try decoder.decodeSingularStringField(value: &levelSpec)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if show != false {
			try visitor.visitSingularBoolField(value: show, fieldNumber: 1)
		}
		if !levelSpec.isEmpty {
			try visitor.visitSingularStringField(value: levelSpec, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DebugLevelResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &subSystems)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !subSystems.isEmpty {
			try visitor.visitSingularStringField(value: subSystems, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PayReqString: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &payReq)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !payReq.isEmpty {
			try visitor.visitSingularStringField(value: payReq, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PayReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &destination)
			case 2: try decoder.decodeSingularStringField(value: &paymentHash)
			case 3: try decoder.decodeSingularInt64Field(value: &numSatoshis)
			case 4: try decoder.decodeSingularInt64Field(value: &timestamp)
			case 5: try decoder.decodeSingularInt64Field(value: &expiry)
			case 6: try decoder.decodeSingularStringField(value: &description_p)
			case 7: try decoder.decodeSingularStringField(value: &descriptionHash)
			case 8: try decoder.decodeSingularStringField(value: &fallbackAddr)
			case 9: try decoder.decodeSingularInt64Field(value: &cltvExpiry)
			case 10: try decoder.decodeRepeatedMessageField(value: &routeHints)
			case 11: try decoder.decodeSingularBytesField(value: &paymentAddr)
			case 12: try decoder.decodeSingularInt64Field(value: &numMsat)
			case 13: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: &features)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !destination.isEmpty {
			try visitor.visitSingularStringField(value: destination, fieldNumber: 1)
		}
		if !paymentHash.isEmpty {
			try visitor.visitSingularStringField(value: paymentHash, fieldNumber: 2)
		}
		if numSatoshis != 0 {
			try visitor.visitSingularInt64Field(value: numSatoshis, fieldNumber: 3)
		}
		if timestamp != 0 {
			try visitor.visitSingularInt64Field(value: timestamp, fieldNumber: 4)
		}
		if expiry != 0 {
			try visitor.visitSingularInt64Field(value: expiry, fieldNumber: 5)
		}
		if !description_p.isEmpty {
			try visitor.visitSingularStringField(value: description_p, fieldNumber: 6)
		}
		if !descriptionHash.isEmpty {
			try visitor.visitSingularStringField(value: descriptionHash, fieldNumber: 7)
		}
		if !fallbackAddr.isEmpty {
			try visitor.visitSingularStringField(value: fallbackAddr, fieldNumber: 8)
		}
		if cltvExpiry != 0 {
			try visitor.visitSingularInt64Field(value: cltvExpiry, fieldNumber: 9)
		}
		if !routeHints.isEmpty {
			try visitor.visitRepeatedMessageField(value: routeHints, fieldNumber: 10)
		}
		if !paymentAddr.isEmpty {
			try visitor.visitSingularBytesField(value: paymentAddr, fieldNumber: 11)
		}
		if numMsat != 0 {
			try visitor.visitSingularInt64Field(value: numMsat, fieldNumber: 12)
		}
		if !features.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32, Lnrpc_Feature>.self, value: features, fieldNumber: 13)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Feature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 3: try decoder.decodeSingularBoolField(value: &isRequired)
			case 4: try decoder.decodeSingularBoolField(value: &isKnown)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if isRequired != false {
			try visitor.visitSingularBoolField(value: isRequired, fieldNumber: 3)
		}
		if isKnown != false {
			try visitor.visitSingularBoolField(value: isKnown, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChannelFeeReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &channelPoint)
			case 2: try decoder.decodeSingularInt64Field(value: &baseFeeMsat)
			case 3: try decoder.decodeSingularInt64Field(value: &feePerMil)
			case 4: try decoder.decodeSingularDoubleField(value: &feeRate)
			case 5: try decoder.decodeSingularUInt64Field(value: &chanID)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if baseFeeMsat != 0 {
			try visitor.visitSingularInt64Field(value: baseFeeMsat, fieldNumber: 2)
		}
		if feePerMil != 0 {
			try visitor.visitSingularInt64Field(value: feePerMil, fieldNumber: 3)
		}
		if feeRate != 0 {
			try visitor.visitSingularDoubleField(value: feeRate, fieldNumber: 4)
		}
		if chanID != 0 {
			try visitor.visitSingularUInt64Field(value: chanID, fieldNumber: 5)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FeeReportResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &channelFees)
			case 2: try decoder.decodeSingularUInt64Field(value: &dayFeeSum)
			case 3: try decoder.decodeSingularUInt64Field(value: &weekFeeSum)
			case 4: try decoder.decodeSingularUInt64Field(value: &monthFeeSum)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !channelFees.isEmpty {
			try visitor.visitRepeatedMessageField(value: channelFees, fieldNumber: 1)
		}
		if dayFeeSum != 0 {
			try visitor.visitSingularUInt64Field(value: dayFeeSum, fieldNumber: 2)
		}
		if weekFeeSum != 0 {
			try visitor.visitSingularUInt64Field(value: weekFeeSum, fieldNumber: 3)
		}
		if monthFeeSum != 0 {
			try visitor.visitSingularUInt64Field(value: monthFeeSum, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PolicyUpdateRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try {
					...
					if let current = self.scope {
						hadOneofValue = true
						if case let .chanPoint(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 3: try decoder.decodeSingularInt64Field(value: &baseFeeMsat)
			case 4: try decoder.decodeSingularDoubleField(value: &feeRate)
			case 5: try decoder.decodeSingularUInt32Field(value: &timeLockDelta)
			case 6: try decoder.decodeSingularUInt64Field(value: &maxHtlcMsat)
			case 7: try decoder.decodeSingularUInt64Field(value: &minHtlcMsat)
			case 8: try decoder.decodeSingularBoolField(value: &minHtlcMsatSpecified)
			case 9: try decoder.decodeSingularUInt32Field(value: &feeRatePpm)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		switch scope {
		case .global?: try {
				guard case let .global(v)? = self.scope else { preconditionFailure() }
				try visitor.visitSingularBoolField(value: v, fieldNumber: 1)
			}()
		case .chanPoint?: try {
				guard case let .chanPoint(v)? = self.scope else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case nil: break
		}
		if baseFeeMsat != 0 {
			try visitor.visitSingularInt64Field(value: baseFeeMsat, fieldNumber: 3)
		}
		if feeRate != 0 {
			try visitor.visitSingularDoubleField(value: feeRate, fieldNumber: 4)
		}
		if timeLockDelta != 0 {
			try visitor.visitSingularUInt32Field(value: timeLockDelta, fieldNumber: 5)
		}
		if maxHtlcMsat != 0 {
			try visitor.visitSingularUInt64Field(value: maxHtlcMsat, fieldNumber: 6)
		}
		if minHtlcMsat != 0 {
			try visitor.visitSingularUInt64Field(value: minHtlcMsat, fieldNumber: 7)
		}
		if minHtlcMsatSpecified != false {
			try visitor.visitSingularBoolField(value: minHtlcMsatSpecified, fieldNumber: 8)
		}
		if feeRatePpm != 0 {
			try visitor.visitSingularUInt32Field(value: feeRatePpm, fieldNumber: 9)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_FailedUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularEnumField(value: &reason)
			case 3: try decoder.decodeSingularStringField(value: &updateError)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if reason != .unknown {
			try visitor.visitSingularEnumField(value: reason, fieldNumber: 2)
		}
		if !updateError.isEmpty {
			try visitor.visitSingularStringField(value: updateError, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_PolicyUpdateResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &failedUpdates)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !failedUpdates.isEmpty {
			try visitor.visitRepeatedMessageField(value: failedUpdates, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ForwardingHistoryRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &startTime)
			case 2: try decoder.decodeSingularUInt64Field(value: &endTime)
			case 3: try decoder.decodeSingularUInt32Field(value: &indexOffset)
			case 4: try decoder.decodeSingularUInt32Field(value: &numMaxEvents)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if startTime != 0 {
			try visitor.visitSingularUInt64Field(value: startTime, fieldNumber: 1)
		}
		if endTime != 0 {
			try visitor.visitSingularUInt64Field(value: endTime, fieldNumber: 2)
		}
		if indexOffset != 0 {
			try visitor.visitSingularUInt32Field(value: indexOffset, fieldNumber: 3)
		}
		if numMaxEvents != 0 {
			try visitor.visitSingularUInt32Field(value: numMaxEvents, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ForwardingEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &timestamp)
			case 2: try decoder.decodeSingularUInt64Field(value: &chanIDIn)
			case 4: try decoder.decodeSingularUInt64Field(value: &chanIDOut)
			case 5: try decoder.decodeSingularUInt64Field(value: &amtIn)
			case 6: try decoder.decodeSingularUInt64Field(value: &amtOut)
			case 7: try decoder.decodeSingularUInt64Field(value: &fee)
			case 8: try decoder.decodeSingularUInt64Field(value: &feeMsat)
			case 9: try decoder.decodeSingularUInt64Field(value: &amtInMsat)
			case 10: try decoder.decodeSingularUInt64Field(value: &amtOutMsat)
			case 11: try decoder.decodeSingularUInt64Field(value: &timestampNs)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if chanIDIn != 0 {
			try visitor.visitSingularUInt64Field(value: chanIDIn, fieldNumber: 2)
		}
		if chanIDOut != 0 {
			try visitor.visitSingularUInt64Field(value: chanIDOut, fieldNumber: 4)
		}
		if amtIn != 0 {
			try visitor.visitSingularUInt64Field(value: amtIn, fieldNumber: 5)
		}
		if amtOut != 0 {
			try visitor.visitSingularUInt64Field(value: amtOut, fieldNumber: 6)
		}
		if fee != 0 {
			try visitor.visitSingularUInt64Field(value: fee, fieldNumber: 7)
		}
		if feeMsat != 0 {
			try visitor.visitSingularUInt64Field(value: feeMsat, fieldNumber: 8)
		}
		if amtInMsat != 0 {
			try visitor.visitSingularUInt64Field(value: amtInMsat, fieldNumber: 9)
		}
		if amtOutMsat != 0 {
			try visitor.visitSingularUInt64Field(value: amtOutMsat, fieldNumber: 10)
		}
		if timestampNs != 0 {
			try visitor.visitSingularUInt64Field(value: timestampNs, fieldNumber: 11)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ForwardingHistoryResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &forwardingEvents)
			case 2: try decoder.decodeSingularUInt32Field(value: &lastOffsetIndex)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !forwardingEvents.isEmpty {
			try visitor.visitRepeatedMessageField(value: forwardingEvents, fieldNumber: 1)
		}
		if lastOffsetIndex != 0 {
			try visitor.visitSingularUInt32Field(value: lastOffsetIndex, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ExportChannelBackupRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_chanPoint)
			default: break
			}
		}
	}
...
extension Lnrpc_ChannelBackup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_chanPoint)
			case 2: try decoder.decodeSingularBytesField(value: &chanBackup)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !chanBackup.isEmpty {
			try visitor.visitSingularBytesField(value: chanBackup, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_MultiChanBackup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &chanPoints)
			case 2: try decoder.decodeSingularBytesField(value: &multiChanBackup)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !chanPoints.isEmpty {
			try visitor.visitRepeatedMessageField(value: chanPoints, fieldNumber: 1)
		}
		if !multiChanBackup.isEmpty {
			try visitor.visitSingularBytesField(value: multiChanBackup, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ChanBackupSnapshot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularMessageField(value: &_singleChanBackups)
			case 2: try decoder.decodeSingularMessageField(value: &_multiChanBackup)
			default: break
			}
		}
	}
...
extension Lnrpc_ChannelBackups: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &chanBackups)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !chanBackups.isEmpty {
			try visitor.visitRepeatedMessageField(value: chanBackups, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RestoreChanBackupRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
		...
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 1: try {
					...
					if let current = self.backup {
						hadOneofValue = true
						if case let .chanBackups(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .chanBackups?: try {
				guard case let .chanBackups(v)? = self.backup else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
			}()
		case .multiChanBackup?: try {
				guard case let .multiChanBackup(v)? = self.backup else { preconditionFailure() }
...
extension Lnrpc_MacaroonPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &entity)
			case 2: try decoder.decodeSingularStringField(value: &action)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !entity.isEmpty {
			try visitor.visitSingularStringField(value: entity, fieldNumber: 1)
		}
		if !action.isEmpty {
			try visitor.visitSingularStringField(value: action, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_BakeMacaroonRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedMessageField(value: &permissions)
			case 2: try decoder.decodeSingularUInt64Field(value: &rootKeyID)
			case 3: try decoder.decodeSingularBoolField(value: &allowExternalPermissions)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if rootKeyID != 0 {
			try visitor.visitSingularUInt64Field(value: rootKeyID, fieldNumber: 2)
		}
		if allowExternalPermissions != false {
			try visitor.visitSingularBoolField(value: allowExternalPermissions, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_BakeMacaroonResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &macaroon)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !macaroon.isEmpty {
			try visitor.visitSingularStringField(value: macaroon, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListMacaroonIDsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeRepeatedUInt64Field(value: &rootKeyIds)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !rootKeyIds.isEmpty {
			try visitor.visitPackedUInt64Field(value: rootKeyIds, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DeleteMacaroonIDRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &rootKeyID)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if rootKeyID != 0 {
			try visitor.visitSingularUInt64Field(value: rootKeyID, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_DeleteMacaroonIDResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBoolField(value: &deleted)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if deleted != false {
			try visitor.visitSingularBoolField(value: deleted, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_ListPermissionsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_MacaroonPermissionList>.self, value: &methodPermissions)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !methodPermissions.isEmpty {
			try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, Lnrpc_MacaroonPermissionList>.self, value: methodPermissions, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Failure: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		...
		var _channelUpdate: Lnrpc_ChannelUpdate?
		var _htlcMsat: UInt64 = 0
		var _onionSha256: Data = .init()
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		...
		try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
			while let fieldNumber = try decoder.nextFieldNumber() {
				...
				case 9: try decoder.decodeSingularUInt32Field(value: &_storage._height)
				default: break
				}
			}
		}
...
extension Lnrpc_ChannelUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularBytesField(value: &chainHash)
			case 3: try decoder.decodeSingularUInt64Field(value: &chanID)
			case 4: try decoder.decodeSingularUInt32Field(value: &timestamp)
			case 5: try decoder.decodeSingularUInt32Field(value: &channelFlags)
			case 6: try decoder.decodeSingularUInt32Field(value: &timeLockDelta)
			case 7: try decoder.decodeSingularUInt64Field(value: &htlcMinimumMsat)
			case 8: try decoder.decodeSingularUInt32Field(value: &baseFee)
			case 9: try decoder.decodeSingularUInt32Field(value: &feeRate)
			case 10: try decoder.decodeSingularUInt32Field(value: &messageFlags)
			case 11: try decoder.decodeSingularUInt64Field(value: &htlcMaximumMsat)
			case 12: try decoder.decodeSingularBytesField(value: &extraOpaqueData)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if chanID != 0 {
			try visitor.visitSingularUInt64Field(value: chanID, fieldNumber: 3)
		}
		if timestamp != 0 {
			try visitor.visitSingularUInt32Field(value: timestamp, fieldNumber: 4)
		}
		if channelFlags != 0 {
			try visitor.visitSingularUInt32Field(value: channelFlags, fieldNumber: 5)
		}
		if timeLockDelta != 0 {
			try visitor.visitSingularUInt32Field(value: timeLockDelta, fieldNumber: 6)
		}
		if htlcMinimumMsat != 0 {
			try visitor.visitSingularUInt64Field(value: htlcMinimumMsat, fieldNumber: 7)
		}
		if baseFee != 0 {
			try visitor.visitSingularUInt32Field(value: baseFee, fieldNumber: 8)
		}
		if feeRate != 0 {
			try visitor.visitSingularUInt32Field(value: feeRate, fieldNumber: 9)
		}
		if messageFlags != 0 {
			try visitor.visitSingularUInt32Field(value: messageFlags, fieldNumber: 10)
		}
		if htlcMaximumMsat != 0 {
			try visitor.visitSingularUInt64Field(value: htlcMaximumMsat, fieldNumber: 11)
		}
		if !extraOpaqueData.isEmpty {
			try visitor.visitSingularBytesField(value: extraOpaqueData, fieldNumber: 12)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_MacaroonId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &nonce)
			case 2: try decoder.decodeSingularBytesField(value: &storageID)
			case 3: try decoder.decodeRepeatedMessageField(value: &ops)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !nonce.isEmpty {
			try visitor.visitSingularBytesField(value: nonce, fieldNumber: 1)
		}
		if !storageID.isEmpty {
			try visitor.visitSingularBytesField(value: storageID, fieldNumber: 2)
		}
		if !ops.isEmpty {
			try visitor.visitRepeatedMessageField(value: ops, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_Op: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &entity)
			case 2: try decoder.decodeRepeatedStringField(value: &actions)
			default: break
			}
		}
	}
...
extension Lnrpc_CheckMacPermRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularBytesField(value: &macaroon)
			case 2: try decoder.decodeRepeatedMessageField(value: &permissions)
			case 3: try decoder.decodeSingularStringField(value: &fullMethod)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !macaroon.isEmpty {
			try visitor.visitSingularBytesField(value: macaroon, fieldNumber: 1)
		}
		if !permissions.isEmpty {
			try visitor.visitRepeatedMessageField(value: permissions, fieldNumber: 2)
		}
		if !fullMethod.isEmpty {
			try visitor.visitSingularStringField(value: fullMethod, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RPCMiddlewareRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &requestID)
			case 2: try decoder.decodeSingularBytesField(value: &rawMacaroon)
			case 3: try decoder.decodeSingularStringField(value: &customCaveatCondition)
			case 4: try {
					var v: Lnrpc_StreamAuth?
					var hadOneofValue = false
					if let current = self.interceptType {
						hadOneofValue = true
						if case let .streamAuth(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 5: try {
					...
					if let current = self.interceptType {
						hadOneofValue = true
						if case let .request(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 6: try {
					...
					if let current = self.interceptType {
						hadOneofValue = true
						if case let .response(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 7: try decoder.decodeSingularUInt64Field(value: &msgID)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if requestID != 0 {
			try visitor.visitSingularUInt64Field(value: requestID, fieldNumber: 1)
		}
		if !rawMacaroon.isEmpty {
			try visitor.visitSingularBytesField(value: rawMacaroon, fieldNumber: 2)
		}
		if !customCaveatCondition.isEmpty {
			try visitor.visitSingularStringField(value: customCaveatCondition, fieldNumber: 3)
		}
		switch interceptType {
		case .streamAuth?: try {
				guard case let .streamAuth(v)? = self.interceptType else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
			}()
		case .request?: try {
				guard case let .request(v)? = self.interceptType else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
			}()
		case .response?: try {
				guard case let .response(v)? = self.interceptType else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
			}()
		case nil: break
		}
		if msgID != 0 {
			try visitor.visitSingularUInt64Field(value: msgID, fieldNumber: 7)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_StreamAuth: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &methodFullUri)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !methodFullUri.isEmpty {
			try visitor.visitSingularStringField(value: methodFullUri, fieldNumber: 1)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RPCMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &methodFullUri)
			case 2: try decoder.decodeSingularBoolField(value: &streamRpc)
			case 3: try decoder.decodeSingularStringField(value: &typeName)
			case 4: try decoder.decodeSingularBytesField(value: &serialized)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if streamRpc != false {
			try visitor.visitSingularBoolField(value: streamRpc, fieldNumber: 2)
		}
		if !typeName.isEmpty {
			try visitor.visitSingularStringField(value: typeName, fieldNumber: 3)
		}
		if !serialized.isEmpty {
			try visitor.visitSingularBytesField(value: serialized, fieldNumber: 4)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_RPCMiddlewareResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt64Field(value: &refMsgID)
			case 2: try {
					var v: Lnrpc_MiddlewareRegistration?
					var hadOneofValue = false
					if let current = self.middlewareMessage {
						hadOneofValue = true
						if case let .register(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
			...
			case 3: try {
					...
					if let current = self.middlewareMessage {
						hadOneofValue = true
						if case let .feedback(m) = current { v = m }
					}
					try decoder.decodeSingularMessageField(value: &v)
					if let v = v {
						if hadOneofValue { try decoder.handleConflictingOneOf() }
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		// https://github.com/apple/swift-protobuf/issues/1182
		if refMsgID != 0 {
			try visitor.visitSingularUInt64Field(value: refMsgID, fieldNumber: 1)
		}
		switch middlewareMessage {
		case .register?: try {
				guard case let .register(v)? = self.middlewareMessage else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
			}()
		case .feedback?: try {
				guard case let .feedback(v)? = self.middlewareMessage else { preconditionFailure() }
				try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
			}()
		case nil: break
		}
...
extension Lnrpc_MiddlewareRegistration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &middlewareName)
			case 2: try decoder.decodeSingularStringField(value: &customMacaroonCaveatName)
			case 3: try decoder.decodeSingularBoolField(value: &readOnlyMode)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		if !middlewareName.isEmpty {
			try visitor.visitSingularStringField(value: middlewareName, fieldNumber: 1)
		}
		if !customMacaroonCaveatName.isEmpty {
			try visitor.visitSingularStringField(value: customMacaroonCaveatName, fieldNumber: 2)
		}
		if readOnlyMode != false {
			try visitor.visitSingularBoolField(value: readOnlyMode, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Lnrpc_InterceptFeedback: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try decoder.decodeSingularBoolField(value: &replaceResponse)
			case 3: try decoder.decodeSingularBytesField(value: &replacementSerialized)
			default: break
			}
		}
	}
	...
	func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if replaceResponse != false {
			try visitor.visitSingularBoolField(value: replaceResponse, fieldNumber: 2)
		}
		if !replacementSerialized.isEmpty {
			try visitor.visitSingularBytesField(value: replacementSerialized, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}

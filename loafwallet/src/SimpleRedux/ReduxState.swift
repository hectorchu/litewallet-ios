...
struct WalletState {
	...
	static var initial: WalletState {
		return WalletState(isConnected: false, syncProgress: 0.0, syncState: .success, balance: nil, transactions: [], lastBlockTimestamp: 1317972665, name: S.AccountHeader.defaultWalletName.localize(), creationDate: Date.zeroValue(), isRescanning: false)
	}
}
